//////////
//
// /libsf/source/superjet/c++/superjet.cpp
//
//////
//    _     _ _     _____ _____ 
//   | |   (_) |__ / ____|  ___|
...
//////
//
// Liberty Software Foundation's SuperJet Simulator (six cylinder engine
// fuel injection simulation for 1990 Ford F-150 4.9L I6).
//
//////
...
//////
	...
	#define _SUPERJET_COMPILE 1				// Turns on some features in VJr for superjet
	#define _BMP_LOCALITY 1					// Force definitions to be local
	const char cgc_appName[] = "superjet";	// Give our app a name
	



//////////
// Include VJr stuff, then superjet stuff
//////
	#include "superjet.h"
