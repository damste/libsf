...
iDisk_deleteFile((cs8*)cgcScreenDataFilename);
		if (!iSEM_load_fromDisk(NULL, screenData, cgcScreenDataFilename, false, true))
		{
			...
			iSEM_appendLine(screenData, (u8*)"Please report any bugs:  http://www.visual-freepro.org/vjr <br>");
			iSEM_appendLine(screenData, (u8*)"Thank you, and may the <color=\"D00\"><b>Lord Jesus Christ</b><color=\"000\"> bless you richly. <bgcolor=\"FF0\">:-)<bgcolor=\"FFF\"><br>");
			...
			iSEM_appendLine(screenData, (u8*)"  <bgcolor=\"20a020\">             <bgcolor=\"FFF\">       <bgcolor=\"1050ff\">             <bgcolor=\"FFF\">      Contributors:<br>");
			iSEM_appendLine(screenData, (u8*)"  <bgcolor=\"20a020\">             <bgcolor=\"FFF\">       <bgcolor=\"1050ff\">             <bgcolor=\"FFF\">         <b>Hernan Cano</b>, <b>Stefano D'Amico</b><br>");
			iSEM_appendLine(screenData, (u8*)"  <bgcolor=\"20a020\">             <bgcolor=\"FFF\">       <bgcolor=\"1050ff\">             <bgcolor=\"FFF\">    <br>");
			iSEM_appendLine(screenData, (u8*)"  <bgcolor=\"20a020\">             <bgcolor=\"FFF\">       <bgcolor=\"1050ff\">             <bgcolor=\"FFF\">    Lead Project Contact:  rick.c.hodgin@gmail.com<br>");
			iSEM_appendLine(screenData, (u8*)"  <bgcolor=\"20a020\">             <bgcolor=\"FFF\">       <bgcolor=\"1050ff\">             <bgcolor=\"FFF\">    <br>");
