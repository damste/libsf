...
//////////
		...
		if (!iSEM_load_fromDisk(NULL, screenData, cgcScreenDataFilename, false, true))
		{
			...
			iSEM_appendLine(screenData, (u8*)"<tt>              _____              </tt>In God's sight we've come together.<br>", -1, false);
			iSEM_appendLine(screenData, (u8*)"<tt>             |     |             </tt>We've come together to help each other.<br>", -1, false);
			iSEM_appendLine(screenData, (u8*)"<tt>             |     |             </tt>Let's grow this project up ... together!<br>", -1, false);
			iSEM_appendLine(screenData, (u8*)"<tt>     ________|     |________     </tt>In service and love to The Lord, forever!<br>", -1, false);
			iSEM_appendLine(screenData, (u8*)"<tt>    |                       |</tt><br>", -1, false);
			iSEM_appendLine(screenData, (u8*)"<tt>    |________       ________|</tt>    Sponsored by:<br>", -1, false);
			iSEM_appendLine(screenData, (u8*)"<tt>             |     |    </tt>             LibSF -- Liberty Software Foundation<br>", -1, false);
			iSEM_appendLine(screenData, (u8*)"<tt>             |     |</tt><br>", -1, false);
			iSEM_appendLine(screenData, (u8*)"<tt>             |     |    </tt>Contributors:<br>", -1, false);
			iSEM_appendLine(screenData, (u8*)"<tt>             |     |    </tt>    Hernan Cano, Stefano D'Amico<br>", -1, false);
			iSEM_appendLine(screenData, (u8*)"<tt>             |     |</tt><br>", -1, false);
			iSEM_appendLine(screenData, (u8*)"<tt>             |     |    </tt>Lead Project Contact:  rick.c.hodgin@gmail.com<br>", -1, false);
			iSEM_appendLine(screenData, (u8*)"<tt>             |     |</tt><br>", -1, false);
			iSEM_appendLine(screenData, (u8*)"<tt>             |     |    </tt>We need more coders. Please consider helping out.<br>", -1, false);
			iSEM_appendLine(screenData, (u8*)"<tt>             |_____|    </tt>Your contribution would make a difference. :-)<br>", -1, false);
			iSEM_appendLine(screenData, NULL, 0, false);
		}
