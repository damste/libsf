...
//	const s8		cgc_view[]												= "view";
	...
	const u32		_INDEX_CENTERED											= 44;
	const u32		_INDEX_CENTURY											= 45;
	const u32		_INDEX_CHILDORDER										= 46;
	const u32		_INDEX_CLASS											= 47;
	const u32		_INDEX_CLASSLIBRARY										= 48;
	const u32		_INDEX_CLIPCONTROLS										= 49;
	const u32		_INDEX_CLOSABLE											= 50;
	const u32		_INDEX_COLORSCHEME										= 51;
	const u32		_INDEX_COLORSOURCE										= 52;
	const u32		_INDEX_COLUMNCOUNT										= 53;
	const u32		_INDEX_COLUMNLINES										= 54;
	const u32		_INDEX_COLUMNORDER										= 55;
	const u32		_INDEX_COLUMNS											= 56;
	const u32		_INDEX_COLUMNWIDTHS										= 57;
	const u32		_INDEX_COMMENT											= 58;
	...
	const u32		_INDEX_MOUSEDOWNX										= 213;
	const u32		_INDEX_MOUSEDOWNY										= 214;
	const u32		_INDEX_MOUSEICON										= 215;
	const u32		_INDEX_MOUSEPOINTER										= 216;
	const u32		_INDEX_MOVABLE											= 217;
	const u32		_INDEX_MOVERBARS										= 218;
	const u32		_INDEX_MULTISELECT										= 219;
	const u32		_INDEX_NAME												= 220;
	const u32		_INDEX_NECOLOR											= 221;
	const u32		_INDEX_NEWINDEX											= 222;
	const u32		_INDEX_NEWITEMID										= 223;
	const u32		_INDEX_NULLDISPLAY										= 224;
	const u32		_INDEX_NUMBEROFELEMENTS									= 225;
	const u32		_INDEX_NWCOLOR											= 226;
	const u32		_INDEX_OBJECT											= 227;
	const u32		_INDEX_OBJECTS											= 228;
	const u32		_INDEX_OLECLASS											= 229;
	const u32		_INDEX_OLEDRAGMODE										= 230;
	const u32		_INDEX_OLEDRAGPICTURE									= 231;
	const u32		_INDEX_OLEDROPEFFECTS									= 232;
	const u32		_INDEX_OLEDROPHASDATA									= 233;
	const u32		_INDEX_OLEDROPMODE										= 234;
	const u32		_INDEX_OLEDROPTEXTINSERTION								= 235;
	const u32		_INDEX_OLELCID											= 236;
	const u32		_INDEX_OLETYPEALLOWED									= 237;
	const u32		_INDEX_OPENWINDOW										= 238;
	const u32		_INDEX_OPTIMIZE											= 239;
	const u32		_INDEX_PAGECOUNT										= 240;
	const u32		_INDEX_PAGEHEIGHT										= 241;
	const u32		_INDEX_PAGEORDER										= 242;
	const u32		_INDEX_PAGES											= 243;
	const u32		_INDEX_PAGEWIDTH										= 244;
	const u32		_INDEX_PANEL											= 245;
	const u32		_INDEX_PANELLINK										= 246;
	const u32		_INDEX_PARENT											= 247;
	const u32		_INDEX_PARENTCLASS										= 248;
	const u32		_INDEX_PARTITION										= 249;
	const u32		_INDEX_PASSWORDCHAR										= 250;
	const u32		_INDEX_PICTURE											= 251;
	const u32		_INDEX_PICTUREBMP										= 252;
	const u32		_INDEX_PICTUREBMP_DOWN									= 253;
	const u32		_INDEX_PICTUREBMP_OVER									= 254;
	const u32		_INDEX_PICTUREMARGIN									= 255;
	const u32		_INDEX_PICTUREPOSITION									= 256;
	const u32		_INDEX_PICTURESELECTIONDISPLAY							= 257;
	const u32		_INDEX_PICTURESPACING									= 258;
	const u32		_INDEX_PICTUREVAL										= 259;
	const u32		_INDEX_POLYPOINTS										= 260;
	const u32		_INDEX_PROCEDURE										= 261;
	const u32		_INDEX_READBACKCOLOR									= 262;
	const u32		_INDEX_READCYCLE										= 263;
	const u32		_INDEX_READFORECOLOR									= 264;
	const u32		_INDEX_READLOCK											= 265;
	const u32		_INDEX_READMOUSE										= 266;
	const u32		_INDEX_READONLY											= 267;
	const u32		_INDEX_READSAVE											= 268;
	const u32		_INDEX_READTIMEOUT										= 269;
	const u32		_INDEX_RECORDMARK										= 270;
	const u32		_INDEX_RECORDSOURCE										= 271;
	const u32		_INDEX_RECORDSOURCETYPE									= 272;
	const u32		_INDEX_RELATIONALEXPR									= 273;
	const u32		_INDEX_RELATIVECOLUMN									= 274;
	const u32		_INDEX_RELATIVEROW										= 275;
	const u32		_INDEX_RELEASETYPE										= 276;
	const u32		_INDEX_RESIZABLE										= 277;
	const u32		_INDEX_RIDERTAB											= 278;
	const u32		_INDEX_RIDERTABCLOSEABLE								= 279;
	const u32		_INDEX_RIGHTTOLEFT										= 280;
	const u32		_INDEX_ROTATEFLIP										= 281;
	const u32		_INDEX_ROTATION											= 282;
	const u32		_INDEX_ROUND_TO											= 283;
	const u32		_INDEX_ROWCOLCHANGE										= 284;
	const u32		_INDEX_ROWHEIGHT										= 285;
	const u32		_INDEX_ROWSOURCE										= 286;
	const u32		_INDEX_ROWSOURCETYPE									= 287;
	const u32		_INDEX_SCALEMODE										= 288;
	const u32		_INDEX_SCROLLBARS										= 289;
	const u32		_INDEX_SCROLLX											= 290;
	const u32		_INDEX_SCROLLY											= 291;
	const u32		_INDEX_SECOLOR											= 292;
	const u32		_INDEX_SECONDS											= 293;
	const u32		_INDEX_SELECTED											= 294;
	const u32		_INDEX_SELECTEDBACKCOLOR								= 295;
	const u32		_INDEX_SELECTEDFORECOLOR								= 296;
	const u32		_INDEX_SELECTEDID										= 297;
	const u32		_INDEX_SELECTEDITEMBACKCOLOR							= 298;
	const u32		_INDEX_SELECTEDITEMFORECOLOR							= 299;
	const u32		_INDEX_SELECTONENTRY									= 300;
	const u32		_INDEX_SELLENGTH										= 301;
	const u32		_INDEX_SELSTART											= 302;
	const u32		_INDEX_SELTEXT											= 303;
	const u32		_INDEX_SHOWINTASKBAR									= 304;
	const u32		_INDEX_SHOWTIPS											= 305;
	const u32		_INDEX_SHOWWINDOW										= 306;
	const u32		_INDEX_SIZABLE											= 307;
	const u32		_INDEX_SIZEBOX											= 308;
	const u32		_INDEX_SORTED											= 309;
	const u32		_INDEX_SPARSE											= 310;
	const u32		_INDEX_SPECIALEFFECT									= 311;
	const u32		_INDEX_SPINNERHIGHVALUE									= 312;
	const u32		_INDEX_SPINNERLOWVALUE									= 313;
	const u32		_INDEX_SPLITBAR											= 314;
	const u32		_INDEX_STACKLEVEL										= 315;
	const u32		_INDEX_STATUSBARTEXT									= 316;
	const u32		_INDEX_STRETCH											= 317;
	const u32		_INDEX_STRICTDATEENTRY									= 318;
	const u32		_INDEX_STYLE											= 319;
	const u32		_INDEX_SWCOLOR											= 320;
	const u32		_INDEX_TABINDEX											= 321;
	const u32		_INDEX_TABORIENTATION									= 322;
	const u32		_INDEX_TABS												= 323;
	const u32		_INDEX_TABSTOP											= 324;
	const u32		_INDEX_TABSTYLE											= 325;
	const u32		_INDEX_TAG												= 326;
	const u32		_INDEX_TERMINATEREAD									= 327;
	const u32		_INDEX_TEXT												= 328;
	const u32		_INDEX_THEMES											= 329;
	const u32		_INDEX_TITLEBAR											= 330;
	const u32		_INDEX_TOOLTIPTEXT										= 331;
	const u32		_INDEX_TOP												= 332;
	const u32		_INDEX_TOPINDEX											= 333;
	const u32		_INDEX_TOPITEMID										= 334;
	const u32		_INDEX_USERVALUE										= 335;
	const u32		_INDEX_VALUE											= 336;
	const u32		_INDEX_VALUE_MAXIMUM									= 337;
	const u32		_INDEX_VALUE_MINIMUM									= 338;
	const u32		_INDEX_VIEW												= 339;
	const u32		_INDEX_VIEWPORTHEIGHT									= 340;
	const u32		_INDEX_VIEWPORTLEFT										= 341;
	const u32		_INDEX_VIEWPORTTOP										= 342;
	const u32		_INDEX_VIEWPORTWIDTH									= 343;
	const u32		_INDEX_VISIBLE											= 344;
	const u32		_INDEX_VISUALEFFECT										= 345;
	const u32		_INDEX_VSCROLLSMALLCHANGE								= 346;
	const u32		_INDEX_WHATSTHISBUTTON									= 347;
	const u32		_INDEX_WHATSTHISHELP									= 348;
	const u32		_INDEX_WHATSTHISHELPID									= 349;
	const u32		_INDEX_WIDTH											= 350;
	const u32		_INDEX_WINDOWLIST										= 351;
	const u32		_INDEX_WINDOWSTATE										= 352;
	const u32		_INDEX_WINDOWTYPE										= 353;
	const u32		_INDEX_WORDWRAP											= 354;
	const u32		_INDEX_ZOOMBOX											= 355;
		// For _settings object
		const u32		_INDEX_SET_FIRST_ITEM							= 356;
	const u32		_INDEX_SET_AUTO_CONVERT									= 356;
	const u32		_INDEX_SET_AUTO_VALIDATE								= 357;
	const u32		_INDEX_SET_BLOCKSIZE									= 358;
	const u32		_INDEX_SET_CASE_SENSITIVE_COMPARES						= 359;
	const u32		_INDEX_SET_CASE_SENSITIVE_NAMES							= 360;
	const u32		_INDEX_SET_CENTURY										= 361;
	const u32		_INDEX_SET_CURRENCY										= 362;
	const u32		_INDEX_SET_DATE											= 363;
	const u32		_INDEX_SET_DECIMALS										= 364;
	const u32		_INDEX_SET_DEVICE										= 365;
	const u32		_INDEX_SET_DEVICE2										= 366;
	const u32		_INDEX_SET_EXCLUSIVE									= 367;
	const u32		_INDEX_SET_FOCUS_HIGHLIGHT_BORDER_PIXELS				= 368;
	const u32		_INDEX_SET_FOCUS_OBJ_PIXELS								= 369;
	const u32		_INDEX_SET_HONOR_BARRIERS								= 370;
	const u32		_INDEX_SET_HOURS										= 371;
	const u32		_INDEX_SET_IMPLICIT_PARAMS								= 372;
	const u32		_INDEX_SET_INDEX_META_DATA								= 373;
	const u32		_INDEX_SET_INITIALIZE_DEFAULT_VALUE						= 374;
	const u32		_INDEX_SET_LANGUAGE										= 375;
	const u32		_INDEX_SET_LOAD_RECEIVES_PARAMS							= 376;
	const u32		_INDEX_SET_LOCK_SCREEN									= 377;
	const u32		_INDEX_SET_LOGICAL										= 378;
	const u32		_INDEX_SET_MARK											= 379;
	const u32		_INDEX_SET_NAMING_CONVENTIONS							= 380;

	const u32									_INDEX_SET_NCSET_START	= 381;
	const u32		_INDEX_SET_NCSET_ALPHA_IS_OPAQUE						= 381;
	const u32		_INDEX_SET_NCSET_CEILING_FLOOR							= 382;
	const u32		_INDEX_SET_NCSET_DATETIME_MILLISECONDS					= 383;
	const u32		_INDEX_SET_NCSET_OPTIMIZE_TABLE_WRITES					= 384;
	const u32		_INDEX_SET_NCSET_OPTIMIZE_VARIABLES						= 385;
	const u32		_INDEX_SET_NCSET_SIGN_SIGN2								= 386;
	const u32		_INDEX_SET_NCSET_PLACEHOLDER1							= 387;
	const u32		_INDEX_SET_NCSET_PLACEHOLDER2							= 388;
	const u32		_INDEX_SET_NCSET_DIRECT_NATIVE_MEMBERS					= 389;
	const u32									_INDEX_SET_NCSET_END	= 389;
	
	const u32		_INDEX_SET_POINT										= 390;
	const u32		_INDEX_SET_PRECISIONBFP									= 391;		// numeric, defaults to 256
	const u32		_INDEX_SET_PRECISIONBI									= 392;		// numeric, defaults to 256
	const u32		_INDEX_SET_REPROCESS									= 393;		// logical, or numeric (negative = attempts, positive = seconds)
	const u32		_INDEX_SET_REPROCESSATTEMPTS							= 394;		// numeric, 30 by default, but can be changed with SET REPROCESSATTEMPTS TO 30
	const u32		_INDEX_SET_REPROCESSINTERVAL							= 395;		// numeric, 1000 by default indicating 1000 milliseconds, or 1 second
	const u32		_INDEX_SET_REPROCESS_SYSTEM								= 396;		// logical, or numeric (negative = attempts, positive = seconds)
	const u32		_INDEX_SET_SEPARATOR									= 397;
	const u32		_INDEX_SET_SLOPPY_PRINTING								= 398;
	const u32		_INDEX_SET_STICKY_PARAMETERS							= 399;
	const u32		_INDEX_SET_TABLE_EQUAL_ASSIGNMENTS						= 400;
	const u32		_INDEX_SET_TABLE_OBJECTS								= 401;
	const u32		_INDEX_SET_TALK											= 402;
	const u32		_INDEX_SET_TIME											= 403;
	const u32		_INDEX_SET_UDFPARMS										= 404;
	const u32		_INDEX_SET_UNLOAD_RECEIVES_PARAMS						= 405;
	const u32		_INDEX_SET_VARIABLES_FIRST								= 406;
	const u32		_INDEX_SET_VECSEPARATOR									= 407;
