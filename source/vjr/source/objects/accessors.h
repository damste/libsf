...
//	const s8		cgc_view[]												= "view";
	...
	const u32		_INDEX_HTML_SCROLLX										= 166;
	const u32		_INDEX_HTML_SCROLLY										= 167;
	const u32		_INDEX_HTML_ZOOM										= 168;
	const u32		_INDEX_ICON												= 169;
	const u32		_INDEX_IMEMODE											= 170;
	const u32		_INDEX_INCREMENT										= 171;
	const u32		_INDEX_INCREMENTALSEARCH								= 172;
	const u32		_INDEX_INPUTMASK										= 173;
	const u32		_INDEX_INTEGRALHEIGHT									= 174;
	const u32		_INDEX_INTERVAL											= 175;
	const u32		_INDEX_ITEMBACKCOLOR									= 176;
	const u32		_INDEX_ITEMDATA											= 177;
	const u32		_INDEX_ITEMFORECOLOR									= 178;
	const u32		_INDEX_ITEMIDDATA										= 179;
	const u32		_INDEX_ITEMTIPS											= 180;
	const u32		_INDEX_KEYBOARDHIGHVALUE								= 181;
	const u32		_INDEX_KEYBOARDLOWVALUE									= 182;
	const u32		_INDEX_KEYPREVIEW										= 183;
	const u32		_INDEX_KEYSORT											= 184;
	const u32		_INDEX_LEFT												= 185;
	const u32		_INDEX_LEFTCOLUMN										= 186;
	const u32		_INDEX_LINECONTENTS										= 187;
	const u32		_INDEX_LINENO											= 188;
	const u32		_INDEX_LINESLANT										= 189;
	const u32		_INDEX_LINKMASTER										= 190;
	const u32		_INDEX_LIST												= 191;
	const u32		_INDEX_LISTCOUNT										= 192;
	const u32		_INDEX_LISTINDEX										= 193;
	const u32		_INDEX_LISTITEM											= 194;
	const u32		_INDEX_LISTITEMID										= 195;
	const u32		_INDEX_LOCKCOLUMNS										= 196;
	const u32		_INDEX_LOCKCOLUMNSLEFT									= 197;
	const u32		_INDEX_LOCKSCREEN										= 198;
	const u32		_INDEX_MACDESKTOP										= 199;
	const u32		_INDEX_MARGIN											= 200;
	const u32		_INDEX_MASK												= 201;
	const u32		_INDEX_MAXBUTTON										= 202;
	const u32		_INDEX_MAXHEIGHT										= 203;
	const u32		_INDEX_MAXLEFT											= 204;
	const u32		_INDEX_MAXLENGTH										= 205;
	const u32		_INDEX_MAXTOP											= 206;
	const u32		_INDEX_MAXWIDTH											= 207;
	const u32		_INDEX_MDIFORM											= 208;
	const u32		_INDEX_MEMBERCLASS										= 209;
	const u32		_INDEX_MEMBERCLASSLIBRARY								= 210;
	const u32		_INDEX_MEMOWINDOW										= 211;
	const u32		_INDEX_MESSAGE											= 212;
	const u32		_INDEX_MINBUTTON										= 213;
	const u32		_INDEX_MINHEIGHT										= 214;
	const u32		_INDEX_MINWIDTH											= 215;
	const u32		_INDEX_MOUSEDOWNTIME									= 216;
	const u32		_INDEX_MOUSEDOWNX										= 217;
	const u32		_INDEX_MOUSEDOWNY										= 218;
	const u32		_INDEX_MOUSEICON										= 219;
	const u32		_INDEX_MOUSEPOINTER										= 220;
	const u32		_INDEX_MOVABLE											= 221;
	const u32		_INDEX_MOVERBARS										= 222;
	const u32		_INDEX_MULTISELECT										= 223;
	const u32		_INDEX_NAME												= 224;
	const u32		_INDEX_NECOLOR											= 225;
	const u32		_INDEX_NEWINDEX											= 226;
	const u32		_INDEX_NEWITEMID										= 227;
	const u32		_INDEX_NULLDISPLAY										= 228;
	const u32		_INDEX_NUMBEROFELEMENTS									= 229;
	const u32		_INDEX_NWCOLOR											= 230;
	const u32		_INDEX_OBJECT											= 231;
	const u32		_INDEX_OBJECTS											= 232;
	const u32		_INDEX_OLECLASS											= 233;
	const u32		_INDEX_OLEDRAGMODE										= 234;
	const u32		_INDEX_OLEDRAGPICTURE									= 235;
	const u32		_INDEX_OLEDROPEFFECTS									= 236;
	const u32		_INDEX_OLEDROPHASDATA									= 237;
	const u32		_INDEX_OLEDROPMODE										= 238;
	const u32		_INDEX_OLEDROPTEXTINSERTION								= 239;
	const u32		_INDEX_OLELCID											= 240;
	const u32		_INDEX_OLETYPEALLOWED									= 241;
	const u32		_INDEX_OPENWINDOW										= 242;
	const u32		_INDEX_OPTIMIZE											= 243;
	const u32		_INDEX_PAGECOUNT										= 244;
	const u32		_INDEX_PAGEHEIGHT										= 245;
	const u32		_INDEX_PAGEORDER										= 246;
	const u32		_INDEX_PAGES											= 247;
	const u32		_INDEX_PAGEWIDTH										= 248;
	const u32		_INDEX_PANEL											= 249;
	const u32		_INDEX_PANELLINK										= 250;
	const u32		_INDEX_PARENT											= 251;
	const u32		_INDEX_PARENTCLASS										= 252;
	const u32		_INDEX_PARTITION										= 253;
	const u32		_INDEX_PASSWORDCHAR										= 254;
	const u32		_INDEX_PICTURE											= 255;
	const u32		_INDEX_PICTUREBMP										= 256;
	const u32		_INDEX_PICTUREBMP_DOWN									= 257;
	const u32		_INDEX_PICTUREBMP_OVER									= 258;
	const u32		_INDEX_PICTUREMARGIN									= 259;
	const u32		_INDEX_PICTUREPOSITION									= 260;
	const u32		_INDEX_PICTURESELECTIONDISPLAY							= 261;
	const u32		_INDEX_PICTURESPACING									= 262;
	const u32		_INDEX_PICTUREVAL										= 263;
	const u32		_INDEX_POLYPOINTS										= 264;
	const u32		_INDEX_PROCEDURE										= 265;
	const u32		_INDEX_READBACKCOLOR									= 266;
	const u32		_INDEX_READCYCLE										= 267;
	const u32		_INDEX_READFORECOLOR									= 268;
	const u32		_INDEX_READLOCK											= 269;
	const u32		_INDEX_READMOUSE										= 270;
	const u32		_INDEX_READONLY											= 271;
	const u32		_INDEX_READSAVE											= 272;
	const u32		_INDEX_READTIMEOUT										= 273;
	const u32		_INDEX_RECORDMARK										= 274;
	const u32		_INDEX_RECORDSOURCE										= 275;
	const u32		_INDEX_RECORDSOURCETYPE									= 276;
	const u32		_INDEX_RELATIONALEXPR									= 277;
	const u32		_INDEX_RELATIVECOLUMN									= 278;
	const u32		_INDEX_RELATIVEROW										= 279;
	const u32		_INDEX_RELEASETYPE										= 280;
	const u32		_INDEX_RESIZABLE										= 281;
	const u32		_INDEX_RIDERTAB											= 282;
	const u32		_INDEX_RIDERTABCLOSEABLE								= 283;
	const u32		_INDEX_RIDERTABCOLLAPSED								= 284;
	const u32		_INDEX_RIDERTYPE										= 285;
	const u32		_INDEX_RIGHTTOLEFT										= 286;
	const u32		_INDEX_ROTATEFLIP										= 287;
	const u32		_INDEX_ROTATION											= 288;
	const u32		_INDEX_ROUND_TO											= 289;
	const u32		_INDEX_ROWCOLCHANGE										= 290;
	const u32		_INDEX_ROWHEIGHT										= 291;
	const u32		_INDEX_ROWSOURCE										= 292;
	const u32		_INDEX_ROWSOURCETYPE									= 293;
	const u32		_INDEX_SCALEMODE										= 294;
	const u32		_INDEX_SCROLLBARS										= 295;
	const u32		_INDEX_SCROLLX											= 296;
	const u32		_INDEX_SCROLLY											= 297;
	const u32		_INDEX_SECOLOR											= 298;
	const u32		_INDEX_SECONDS											= 299;
	const u32		_INDEX_SELECTED											= 300;
	const u32		_INDEX_SELECTEDBACKCOLOR								= 301;
	const u32		_INDEX_SELECTEDFORECOLOR								= 302;
	const u32		_INDEX_SELECTEDID										= 303;
	const u32		_INDEX_SELECTEDITEMBACKCOLOR							= 304;
	const u32		_INDEX_SELECTEDITEMFORECOLOR							= 305;
	const u32		_INDEX_SELECTONENTRY									= 306;
	const u32		_INDEX_SELLENGTH										= 307;
	const u32		_INDEX_SELSTART											= 308;
	const u32		_INDEX_SELTEXT											= 309;
	const u32		_INDEX_SHOWINTASKBAR									= 310;
	const u32		_INDEX_SHOWTIPS											= 311;
	const u32		_INDEX_SHOWWINDOW										= 312;
	const u32		_INDEX_SIZABLE											= 313;
	const u32		_INDEX_SIZEBOX											= 314;
	const u32		_INDEX_SORTED											= 315;
	const u32		_INDEX_SPARSE											= 316;
	const u32		_INDEX_SPECIALEFFECT									= 317;
	const u32		_INDEX_SPINNERHIGHVALUE									= 318;
	const u32		_INDEX_SPINNERLOWVALUE									= 319;
	const u32		_INDEX_SPLITBAR											= 320;
	const u32		_INDEX_STACKLEVEL										= 321;
	const u32		_INDEX_STATUSBARTEXT									= 322;
	const u32		_INDEX_STRETCH											= 323;
	const u32		_INDEX_STRICTDATEENTRY									= 324;
	const u32		_INDEX_STYLE											= 325;
	const u32		_INDEX_SWCOLOR											= 326;
	const u32		_INDEX_TABINDEX											= 327;
	const u32		_INDEX_TABORIENTATION									= 328;
	const u32		_INDEX_TABS												= 329;
	const u32		_INDEX_TABSTOP											= 330;
	const u32		_INDEX_TABSTYLE											= 331;
	const u32		_INDEX_TAG												= 332;
	const u32		_INDEX_TERMINATEREAD									= 333;
	const u32		_INDEX_TEXT												= 334;
	const u32		_INDEX_THEMES											= 335;
	const u32		_INDEX_TITLEBAR											= 336;
	const u32		_INDEX_TOOLTIPTEXT										= 337;
	const u32		_INDEX_TOP												= 338;
	const u32		_INDEX_TOPINDEX											= 339;
	const u32		_INDEX_TOPITEMID										= 340;
	const u32		_INDEX_USERVALUE										= 341;
	const u32		_INDEX_VALUE											= 342;
	const u32		_INDEX_VALUE_MAXIMUM									= 343;
	const u32		_INDEX_VALUE_MINIMUM									= 344;
	const u32		_INDEX_VIEW												= 345;
	const u32		_INDEX_VIEWPORTHEIGHT									= 346;
	const u32		_INDEX_VIEWPORTLEFT										= 347;
	const u32		_INDEX_VIEWPORTTOP										= 348;
	const u32		_INDEX_VIEWPORTWIDTH									= 349;
	const u32		_INDEX_VISIBLE											= 350;
	const u32		_INDEX_VISUALEFFECT										= 351;
	const u32		_INDEX_VSCROLLSMALLCHANGE								= 352;
	const u32		_INDEX_WHATSTHISBUTTON									= 353;
	const u32		_INDEX_WHATSTHISHELP									= 354;
	const u32		_INDEX_WHATSTHISHELPID									= 355;
	const u32		_INDEX_WIDTH											= 356;
	const u32		_INDEX_WINDOWLIST										= 357;
	const u32		_INDEX_WINDOWSTATE										= 358;
	const u32		_INDEX_WINDOWTYPE										= 359;
	const u32		_INDEX_WORDWRAP											= 360;
	const u32		_INDEX_ZOOMBOX											= 361;
		// For _settings object
		const u32		_INDEX_SET_FIRST_ITEM							= 362;
	const u32		_INDEX_SET_AUTO_CONVERT									= 362;
	const u32		_INDEX_SET_AUTO_VALIDATE								= 363;
	const u32		_INDEX_SET_BLOCKSIZE									= 364;
