...
//	const s8		cgc_default[]											= "default";
	...
	const s8		cgc_fontWiden[]											= "fontWiden";
	const s8		cgc_fontWidenSpaces[]									= "cgc_fontWidenSpaces";
	const s8		cgc_fontUnderline[]										= "fontUnderline";
...
//	const s8		cgc_view[]												= "view";
	...
	const u32		_INDEX_FONTWIDEN										= 142;
	const u32		_INDEX_FONTWIDENSPACES									= 143;
	const u32		_INDEX_FORECOLOR										= 144;
	const u32		_INDEX_FORMAT											= 145;
	const u32		_INDEX_FORMCOUNT										= 146;
	const u32		_INDEX_FORMS											= 147;
	const u32		_INDEX_GRIDLINECOLOR									= 148;
	const u32		_INDEX_GRIDLINES										= 149;
	const u32		_INDEX_GRIDLINEWIDTH									= 150;
	const u32		_INDEX_HALFHEIGHTCAPTION								= 151;
	const u32		_INDEX_HEADERCLASS										= 152;
	const u32		_INDEX_HEADERCLASSLIBRARY								= 153;
	const u32		_INDEX_HEADERHEIGHT										= 154;
	const u32		_INDEX_HEIGHT											= 155;
	const u32		_INDEX_HELPCONTEXTID									= 156;
	const u32		_INDEX_HIDESELECTION									= 157;
	const u32		_INDEX_HIGHLIGHT										= 158;
	const u32		_INDEX_HIGHLIGHTBACKCOLOR								= 159;
	const u32		_INDEX_HIGHLIGHTFORECOLOR								= 160;
	const u32		_INDEX_HIGHLIGHTROW										= 161;
	const u32		_INDEX_HIGHLIGHTROWLINEWIDTH							= 162;
	const u32		_INDEX_HIGHLIGHTSTYLE									= 163;
	const u32		_INDEX_HOSTNAME											= 164;
	const u32		_INDEX_HOURS											= 165;
	const u32		_INDEX_HSCROLLSMALLCHANGE								= 166;
	const u32		_INDEX_HWND												= 167;
	const u32		_INDEX_ICON												= 168;
	const u32		_INDEX_IMEMODE											= 169;
	const u32		_INDEX_INCREMENT										= 170;
	const u32		_INDEX_INCREMENTALSEARCH								= 171;
	const u32		_INDEX_INPUTMASK										= 172;
	const u32		_INDEX_INTEGRALHEIGHT									= 173;
	const u32		_INDEX_INTERVAL											= 174;
	const u32		_INDEX_ITEMBACKCOLOR									= 175;
	const u32		_INDEX_ITEMDATA											= 176;
	const u32		_INDEX_ITEMFORECOLOR									= 177;
	const u32		_INDEX_ITEMIDDATA										= 178;
	const u32		_INDEX_ITEMTIPS											= 179;
	const u32		_INDEX_KEYBOARDHIGHVALUE								= 180;
	const u32		_INDEX_KEYBOARDLOWVALUE									= 181;
	const u32		_INDEX_KEYPREVIEW										= 182;
	const u32		_INDEX_KEYSORT											= 183;
	const u32		_INDEX_LEFT												= 184;
	const u32		_INDEX_LEFTCOLUMN										= 185;
	const u32		_INDEX_LINECONTENTS										= 186;
	const u32		_INDEX_LINENO											= 187;
	const u32		_INDEX_LINESLANT										= 188;
	const u32		_INDEX_LINKMASTER										= 189;
	const u32		_INDEX_LIST												= 190;
	const u32		_INDEX_LISTCOUNT										= 191;
	const u32		_INDEX_LISTINDEX										= 192;
	const u32		_INDEX_LISTITEM											= 193;
	const u32		_INDEX_LISTITEMID										= 194;
	const u32		_INDEX_LOCKCOLUMNS										= 195;
	const u32		_INDEX_LOCKCOLUMNSLEFT									= 196;
	const u32		_INDEX_LOCKSCREEN										= 197;
	const u32		_INDEX_MACDESKTOP										= 198;
	const u32		_INDEX_MARGIN											= 199;
	const u32		_INDEX_MASK												= 200;
	const u32		_INDEX_MAXBUTTON										= 201;
	const u32		_INDEX_MAXHEIGHT										= 202;
	const u32		_INDEX_MAXLEFT											= 203;
	const u32		_INDEX_MAXLENGTH										= 204;
	const u32		_INDEX_MAXTOP											= 205;
	const u32		_INDEX_MAXWIDTH											= 206;
	const u32		_INDEX_MDIFORM											= 207;
	const u32		_INDEX_MEMBERCLASS										= 208;
	const u32		_INDEX_MEMBERCLASSLIBRARY								= 209;
	const u32		_INDEX_MEMOWINDOW										= 210;
	const u32		_INDEX_MESSAGE											= 211;
	const u32		_INDEX_MINBUTTON										= 212;
	const u32		_INDEX_MINHEIGHT										= 213;
	const u32		_INDEX_MINWIDTH											= 214;
	const u32		_INDEX_MOUSEDOWNTIME									= 215;
	const u32		_INDEX_MOUSEDOWNX										= 216;
	const u32		_INDEX_MOUSEDOWNY										= 217;
	const u32		_INDEX_MOUSEICON										= 218;
	const u32		_INDEX_MOUSEPOINTER										= 219;
	const u32		_INDEX_MOVABLE											= 220;
	const u32		_INDEX_MOVERBARS										= 221;
	const u32		_INDEX_MULTISELECT										= 222;
	const u32		_INDEX_NAME												= 223;
	const u32		_INDEX_NECOLOR											= 224;
	const u32		_INDEX_NEWINDEX											= 225;
	const u32		_INDEX_NEWITEMID										= 226;
	const u32		_INDEX_NULLDISPLAY										= 227;
	const u32		_INDEX_NUMBEROFELEMENTS									= 228;
	const u32		_INDEX_NWCOLOR											= 229;
	const u32		_INDEX_OBJECT											= 230;
	const u32		_INDEX_OBJECTS											= 231;
	const u32		_INDEX_OLECLASS											= 232;
	const u32		_INDEX_OLEDRAGMODE										= 233;
	const u32		_INDEX_OLEDRAGPICTURE									= 234;
	const u32		_INDEX_OLEDROPEFFECTS									= 235;
	const u32		_INDEX_OLEDROPHASDATA									= 236;
	const u32		_INDEX_OLEDROPMODE										= 237;
	const u32		_INDEX_OLEDROPTEXTINSERTION								= 238;
	const u32		_INDEX_OLELCID											= 239;
	const u32		_INDEX_OLETYPEALLOWED									= 240;
	const u32		_INDEX_OPENWINDOW										= 241;
	const u32		_INDEX_OPTIMIZE											= 242;
	const u32		_INDEX_PAGECOUNT										= 243;
	const u32		_INDEX_PAGEHEIGHT										= 244;
	const u32		_INDEX_PAGEORDER										= 245;
	const u32		_INDEX_PAGES											= 246;
	const u32		_INDEX_PAGEWIDTH										= 247;
	const u32		_INDEX_PANEL											= 248;
	const u32		_INDEX_PANELLINK										= 249;
	const u32		_INDEX_PARENT											= 250;
	const u32		_INDEX_PARENTCLASS										= 251;
	const u32		_INDEX_PARTITION										= 252;
	const u32		_INDEX_PASSWORDCHAR										= 253;
	const u32		_INDEX_PICTURE											= 254;
	const u32		_INDEX_PICTUREBMP										= 255;
	const u32		_INDEX_PICTUREBMP_DOWN									= 256;
	const u32		_INDEX_PICTUREBMP_OVER									= 257;
	const u32		_INDEX_PICTUREMARGIN									= 258;
	const u32		_INDEX_PICTUREPOSITION									= 259;
	const u32		_INDEX_PICTURESELECTIONDISPLAY							= 260;
	const u32		_INDEX_PICTURESPACING									= 261;
	const u32		_INDEX_PICTUREVAL										= 262;
	const u32		_INDEX_POLYPOINTS										= 263;
	const u32		_INDEX_PROCEDURE										= 264;
	const u32		_INDEX_READBACKCOLOR									= 265;
	const u32		_INDEX_READCYCLE										= 266;
	const u32		_INDEX_READFORECOLOR									= 267;
	const u32		_INDEX_READLOCK											= 268;
	const u32		_INDEX_READMOUSE										= 269;
	const u32		_INDEX_READONLY											= 270;
	const u32		_INDEX_READSAVE											= 271;
	const u32		_INDEX_READTIMEOUT										= 272;
	const u32		_INDEX_RECORDMARK										= 273;
	const u32		_INDEX_RECORDSOURCE										= 274;
	const u32		_INDEX_RECORDSOURCETYPE									= 275;
	const u32		_INDEX_RELATIONALEXPR									= 276;
	const u32		_INDEX_RELATIVECOLUMN									= 277;
	const u32		_INDEX_RELATIVEROW										= 278;
	const u32		_INDEX_RELEASETYPE										= 279;
	const u32		_INDEX_RESIZABLE										= 280;
	const u32		_INDEX_RIDERTAB											= 281;
	const u32		_INDEX_RIDERTABCLOSEABLE								= 282;
	const u32		_INDEX_RIDERTABCOLLAPSED								= 283;
	const u32		_INDEX_RIDERTYPE										= 284;
	const u32		_INDEX_RIGHTTOLEFT										= 285;
	const u32		_INDEX_ROTATEFLIP										= 286;
	const u32		_INDEX_ROTATION											= 287;
	const u32		_INDEX_ROUND_TO											= 288;
	const u32		_INDEX_ROWCOLCHANGE										= 289;
	const u32		_INDEX_ROWHEIGHT										= 290;
	const u32		_INDEX_ROWSOURCE										= 291;
	const u32		_INDEX_ROWSOURCETYPE									= 292;
	const u32		_INDEX_SCALEMODE										= 293;
	const u32		_INDEX_SCROLLBARS										= 294;
	const u32		_INDEX_SCROLLX											= 295;
	const u32		_INDEX_SCROLLY											= 296;
	const u32		_INDEX_SECOLOR											= 297;
	const u32		_INDEX_SECONDS											= 298;
	const u32		_INDEX_SELECTED											= 299;
	const u32		_INDEX_SELECTEDBACKCOLOR								= 300;
	const u32		_INDEX_SELECTEDFORECOLOR								= 301;
	const u32		_INDEX_SELECTEDID										= 302;
	const u32		_INDEX_SELECTEDITEMBACKCOLOR							= 303;
	const u32		_INDEX_SELECTEDITEMFORECOLOR							= 304;
	const u32		_INDEX_SELECTONENTRY									= 305;
	const u32		_INDEX_SELLENGTH										= 306;
	const u32		_INDEX_SELSTART											= 307;
	const u32		_INDEX_SELTEXT											= 308;
	const u32		_INDEX_SHOWINTASKBAR									= 309;
	const u32		_INDEX_SHOWTIPS											= 310;
	const u32		_INDEX_SHOWWINDOW										= 311;
	const u32		_INDEX_SIZABLE											= 312;
	const u32		_INDEX_SIZEBOX											= 313;
	const u32		_INDEX_SORTED											= 314;
	const u32		_INDEX_SPARSE											= 315;
	const u32		_INDEX_SPECIALEFFECT									= 316;
	const u32		_INDEX_SPINNERHIGHVALUE									= 317;
	const u32		_INDEX_SPINNERLOWVALUE									= 318;
	const u32		_INDEX_SPLITBAR											= 319;
	const u32		_INDEX_STACKLEVEL										= 320;
	const u32		_INDEX_STATUSBARTEXT									= 321;
	const u32		_INDEX_STRETCH											= 322;
	const u32		_INDEX_STRICTDATEENTRY									= 323;
	const u32		_INDEX_STYLE											= 324;
	const u32		_INDEX_SWCOLOR											= 325;
	const u32		_INDEX_TABINDEX											= 326;
	const u32		_INDEX_TABORIENTATION									= 327;
	const u32		_INDEX_TABS												= 328;
	const u32		_INDEX_TABSTOP											= 329;
	const u32		_INDEX_TABSTYLE											= 330;
	const u32		_INDEX_TAG												= 331;
	const u32		_INDEX_TERMINATEREAD									= 332;
	const u32		_INDEX_TEXT												= 333;
	const u32		_INDEX_THEMES											= 334;
	const u32		_INDEX_TITLEBAR											= 335;
	const u32		_INDEX_TOOLTIPTEXT										= 336;
	const u32		_INDEX_TOP												= 337;
	const u32		_INDEX_TOPINDEX											= 338;
	const u32		_INDEX_TOPITEMID										= 339;
	const u32		_INDEX_USERVALUE										= 340;
	const u32		_INDEX_VALUE											= 341;
	const u32		_INDEX_VALUE_MAXIMUM									= 342;
	const u32		_INDEX_VALUE_MINIMUM									= 343;
	const u32		_INDEX_VIEW												= 344;
	const u32		_INDEX_VIEWPORTHEIGHT									= 345;
	const u32		_INDEX_VIEWPORTLEFT										= 346;
	const u32		_INDEX_VIEWPORTTOP										= 347;
	const u32		_INDEX_VIEWPORTWIDTH									= 348;
	const u32		_INDEX_VISIBLE											= 349;
	const u32		_INDEX_VISUALEFFECT										= 350;
	const u32		_INDEX_VSCROLLSMALLCHANGE								= 351;
	const u32		_INDEX_WHATSTHISBUTTON									= 352;
	const u32		_INDEX_WHATSTHISHELP									= 353;
	const u32		_INDEX_WHATSTHISHELPID									= 354;
	const u32		_INDEX_WIDTH											= 355;
	const u32		_INDEX_WINDOWLIST										= 356;
	const u32		_INDEX_WINDOWSTATE										= 357;
	const u32		_INDEX_WINDOWTYPE										= 358;
	const u32		_INDEX_WORDWRAP											= 359;
	const u32		_INDEX_ZOOMBOX											= 360;
	// For _settings object
	const u32		_INDEX_SET_FIRST_ITEM							= 361;
	const u32		_INDEX_SET_AUTO_CONVERT									= 361;
	const u32		_INDEX_SET_AUTO_VALIDATE								= 362;
	const u32		_INDEX_SET_BLOCKSIZE									= 363;
	const u32		_INDEX_SET_CASE_SENSITIVE_COMPARES						= 364;
	const u32		_INDEX_SET_CASE_SENSITIVE_NAMES							= 365;
	const u32		_INDEX_SET_CENTURY										= 366;
	const u32		_INDEX_SET_CURRENCY										= 367;
	const u32		_INDEX_SET_DATE											= 368;
	const u32		_INDEX_SET_DECIMALS										= 369;
	const u32		_INDEX_SET_DEVICE										= 370;
	const u32		_INDEX_SET_DEVICE2										= 371;
	const u32		_INDEX_SET_EXCLUSIVE									= 372;
	const u32		_INDEX_SET_FOCUS_HIGHLIGHT_BORDER_PIXELS				= 373;
	const u32		_INDEX_SET_FOCUS_OBJ_PIXELS								= 374;
	const u32		_INDEX_SET_HONOR_BARRIERS								= 375;
	const u32		_INDEX_SET_HOURS										= 376;
	const u32		_INDEX_SET_IMPLICIT_PARAMS								= 377;
	const u32		_INDEX_SET_INDEX_META_DATA								= 378;
	const u32		_INDEX_SET_INITIALIZE_DEFAULT_VALUE						= 379;
	const u32		_INDEX_SET_LANGUAGE										= 380;
	const u32		_INDEX_SET_LOAD_RECEIVES_PARAMS							= 381;
	const u32		_INDEX_SET_LOCK_SCREEN									= 382;
	const u32		_INDEX_SET_LOGICAL										= 383;
	const u32		_INDEX_SET_MARK											= 384;
	const u32		_INDEX_SET_NAMING_CONVENTIONS							= 385;

	const u32									_INDEX_SET_NCSET_START	= 386;
	const u32		_INDEX_SET_NCSET_ALPHA_IS_OPAQUE						= 386;
	const u32		_INDEX_SET_NCSET_CEILING_FLOOR							= 387;
	const u32		_INDEX_SET_NCSET_DATETIME_MILLISECONDS					= 388;
	const u32		_INDEX_SET_NCSET_OPTIMIZE_TABLE_WRITES					= 389;
	const u32		_INDEX_SET_NCSET_OPTIMIZE_VARIABLES						= 390;
	const u32		_INDEX_SET_NCSET_SIGN_SIGN2								= 391;
	const u32		_INDEX_SET_NCSET_PLACEHOLDER1							= 392;
	const u32		_INDEX_SET_NCSET_PLACEHOLDER2							= 393;
	const u32		_INDEX_SET_NCSET_DIRECT_NATIVE_MEMBERS					= 394;
...
//////
	...
	{	//	Index within master props						 icode								property text						length of property text								default property type	 init get set		default value					init value (set at launch)
		...
		{	_INDEX_FONTWIDEN,								-1,									cgc_fontWiden,						sizeof(cgc_fontWiden) - 1,							_VAR_TYPE_S32,				0, 0, 0,		0								,NULL	},	// Number of pixels to adjust each character by
		{	_INDEX_FONTWIDENSPACES,							-1,									cgc_fontWidenSpaces,				sizeof(cgc_fontWidenSpaces) - 1,					_VAR_TYPE_S32,				0, 0, 0,		0								,NULL	},	// Number of pixels to adjust each space by
