...
//////
	...
	cs32			_ICODE_SEM_HTML_A								= 1208;
	cs32			_ICODE_SEM_HTML_B								= 1209;
	cs32			_ICODE_SEM_HTML_I								= 1210;
	cs32			_ICODE_SEM_HTML_U								= 1211;
	cs32			_ICODE_SEM_HTML_W								= 1212;
	cs32			_ICODE_SEM_HTML_H								= 1213;
	cs32			_ICODE_SEM_HTML_X								= 1214;
	cs32			_ICODE_SEM_HTML_Y								= 1215;
	cs32			_ICODE_SEM_HTML_BGCOLOR							= 1216;
	cs32			_ICODE_SEM_HTML_COLOR							= 1217;
	cs32			_ICODE_SEM_HTML_ALIGN							= 1218;
	cs32			_ICODE_SEM_HTML_VALIGN							= 1219;
	cs32			_ICODE_SEM_HTML_HEIGHT							= 1220;
	...
	cs32			_ICODE_SEM_HTML_TA								= 1208 + 100;
	cs32			_ICODE_SEM_HTML_TB								= 1209 + 100;
	cs32			_ICODE_SEM_HTML_TI								= 1210 + 100;
	cs32			_ICODE_SEM_HTML_TU								= 1211 + 100;
	cs32			_ICODE_SEM_HTML_TW								= 1212 + 100;
	cs32			_ICODE_SEM_HTML_TH								= 1213 + 100;
	cs32			_ICODE_SEM_HTML_TX								= 1214 + 100;
	cs32			_ICODE_SEM_HTML_TY								= 1215 + 100;
	cs32			_ICODE_SEM_HTML_TBGCOLOR						= 1216 + 100;
	cs32			_ICODE_SEM_HTML_TCOLOR							= 1217 + 100;
	cs32			_ICODE_SEM_HTML_TALIGN							= 1218 + 100;
	cs32			_ICODE_SEM_HTML_TVALIGN							= 1219 + 100;
	cs32			_ICODE_SEM_HTML_THEIGHT							= 1220 + 100;
