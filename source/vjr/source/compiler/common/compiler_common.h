...
/////
	SAsciiCompSearcher	cgcFundamentalSymbols[] =
	{
		...
		{ "++",						2,			false,		_ICODE_PLUS_PLUS,						false,				_ICAT_UNARY,					&colorSynHi_operator,		true,						null0	},
		...
		{ "--",						2,			false,		_ICODE_MINUS_MINUS,						false,				_ICAT_UNARY,					&colorSynHi_operator,		true,						null0	},
		...
		{ "~",						1,			false,		_ICODE_TILDE,							false,				_ICAT_BITWISE,					NULL,						false,						null0	},
		{ "@",						1,			false,		_ICODE_AT_SIGN,							false,				_ICAT_GENERIC,					NULL,						false,						null0	},
		{ "#",						1,			false,		_ICODE_POUND_SIGN,						false,				_ICAT_LOGIC,					&colorSynHi_operator,		false,						null0	},
		{ "$",						1,			false,		_ICODE_DOLLAR_SIGN,						false,				_ICAT_LOGIC,					&colorSynHi_operator,		false,						null0	},
		{ "?",						1,			false,		_ICODE_QUESTION_MARK,					false,				_ICAT_LOGIC,					NULL,						false,						null0	},
		{ "!=",						2,			false,		_ICODE_NOT_EQUAL,						false,				_ICAT_LOGIC,					&colorSynHi_operator,		true,						null0	},
		{ "!<",						2,			false,		_ICODE_GREATER_THAN_OR_EQUAL_TO,		false,				_ICAT_LOGIC,					&colorSynHi_operator,		true,						null0	},
		{ "!>",						2,			false,		_ICODE_LESS_THAN_OR_EQUAL_TO,			false,				_ICAT_LOGIC,					&colorSynHi_operator,		true,						null0	},
		{ "!<=",					3,			false,		_ICODE_GREATER_THAN,					false,				_ICAT_LOGIC,					&colorSynHi_operator,		true,						null0	},
		{ "!>=",					3,			false,		_ICODE_LESS_THAN,						false,				_ICAT_LOGIC,					&colorSynHi_operator,		true,						null0	},
		{ "!",						1,			false,		_ICODE_EXCLAMATION_POINT,				false,				_ICAT_LOGIC | _ICAT_BITWISE,	&colorSynHi_logical,		true,						null0	},
		{ cgcDefinePragma,			7,			false,		_ICODE_DEFINE_PRAGMA,					true,				_ICAT_PRAGMA,					&colorSynHi_pragmas,		false,						null0	},
		{ cgcElsePragma,			5,			false,		_ICODE_ELSE_PRAGMA,						true,				_ICAT_PRAGMA,					&colorSynHi_pragmas,		false,						null0	},
		{ cgcElseifPragma,			7,			false,		_ICODE_ELSEIF_PRAGMA,					true,				_ICAT_PRAGMA,					&colorSynHi_pragmas,		false,						null0	},
		{ cgcEndifPragma,			6,			false,		_ICODE_ENDIF_PRAGMA,					true,				_ICAT_PRAGMA,					&colorSynHi_pragmas,		false,						null0	},
		{ cgcIfPragma,				3,			false,		_ICODE_IF_PRAGMA,						true,				_ICAT_PRAGMA,					&colorSynHi_pragmas,		false,						null0	},
		{ cgcIfdefPragma,			6,			false,		_ICODE_IFDEF_PRAGMA,					true,				_ICAT_PRAGMA,					&colorSynHi_pragmas,		false,						null0	},
		{ cgcIfndefPragma,			7,			false,		_ICODE_IFNDEF_PRAGMA,					true,				_ICAT_PRAGMA,					&colorSynHi_pragmas,		false,						null0	},
		{ cgcIncludePragma,			8,			false,		_ICODE_INCLUDE_PRAGMA,					true,				_ICAT_PRAGMA,					&colorSynHi_pragmas,		false,						null0	},
		{ cgcUndefPragma,			6,			false,		_ICODE_UNDEF_PRAGMA,					true,				_ICAT_PRAGMA,					&colorSynHi_pragmas,		false,						null0	},
		{ "%=",						2,			false,		_ICODE_MODULO_EQUAL,					false,				_ICAT_OPERATOR | _ICAT_ASSIGN,	&colorSynHi_operator,		false,						null0	},
		{ "%",						1,			false,		_ICODE_PERCENT_SIGN,					false,				_ICAT_OPERATOR,					&colorSynHi_operator,		false,						null0	},
		{ "&&",						2,			false,		_ICODE_AND,								false,				_ICAT_LOGIC,					&colorSynHi_logical,		false,						null0	},
		{ "&",						1,			false,		_ICODE_AMPERSAND,						false,				_ICAT_LOGIC,					&colorSynHi_operator,		false,						null0	},
		{ "=<",						2,			false,		_ICODE_LESS_THAN_OR_EQUAL_TO,			false,				_ICAT_LOGIC,					&colorSynHi_operator,		true,						null0	},
		{ "=>",						2,			false,		_ICODE_GREATER_THAN_OR_EQUAL_TO,		false,				_ICAT_LOGIC,					&colorSynHi_operator,		true,						null0	},
		{ "==",						2,			false,		_ICODE_EXACTLY_EQUAL_TO,				false,				_ICAT_LOGIC,					&colorSynHi_operator,		true,						null0	},
		{ "=",						1,			false,		_ICODE_EQUAL_SIGN,						false,				_ICAT_ASSIGN,					&colorSynHi_operator,		true,						null0	},
		{ "||",						2,			false,		_ICODE_OR,								false,				_ICAT_LOGIC,					&colorSynHi_logical,		false,						null0	},
		{ "|=",						2,			false,		_ICODE_OR_ASSIGNMENT,					false,				_ICAT_BITWISE | _ICAT_ASSIGN,	&colorSynHi_operator,		false,						null0	},
		{ "|",						1,			false,		_ICODE_PIPE_SIGN,						false,				_ICAT_BITWISE,					&colorSynHi_operator,		false,						null0	},
		{ "`",						1,			false,		_ICODE_REVERSE_QUOTE,					false,				_ICAT_GENERIC,					NULL,						false,						null0	},
		{ ";",						1,			false,		_ICODE_SEMICOLON,						false,				_ICAT_STOPPER,					NULL,						false,						null0	},
		{ "<<=",					3,			false,		_ICODE_SHIFT_LEFT_ASSIGNMENT,			false,				_ICAT_BITWISE | _ICAT_ASSIGN,	&colorSynHi_operator,		true,						null0	},
		{ "<<",						2,			false,		_ICODE_SHIFT_LEFT,						false,				_ICAT_BITWISE,					&colorSynHi_operator,		true,						null0	},
		{ ">>=",					3,			false,		_ICODE_SHIFT_RIGHT_ASSIGNMENT,			false,				_ICAT_BITWISE | _ICAT_ASSIGN,	&colorSynHi_operator,		true,						null0	},
		{ ">>",						2,			false,		_ICODE_SHIFT_RIGHT,						false,				_ICAT_BITWISE,					&colorSynHi_operator,		true,						null0	},
		{ "<=",						2,			false,		_ICODE_LESS_THAN_OR_EQUAL_TO,			false,				_ICAT_LOGIC,					&colorSynHi_operator,		true,						null0	},
		{ ">=",						2,			false,		_ICODE_GREATER_THAN_OR_EQUAL_TO,		false,				_ICAT_LOGIC,					&colorSynHi_operator,		true,						null0	},
		{ "<>",						2,			false,		_ICODE_NOT_EQUAL,						false,				_ICAT_LOGIC,					&colorSynHi_operator,		true,						null0	},
		{ ">",						1,			false,		_ICODE_GREATER_THAN,					false,				_ICAT_LOGIC,					&colorSynHi_operator,		true,						null0	},
		{ "<",						1,			false,		_ICODE_LESS_THAN,						false,				_ICAT_LOGIC,					&colorSynHi_operator,		true,						null0	},
