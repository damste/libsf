...
//////
	...
	SComp*					iEngine_parse_nonSourceCode_line		(SLine* line, SAsciiCompSearcher* acs2 = NULL);
	SComp*					iEngine_parse_sourceCode_line			(SLine* line, SAsciiCompSearcher* acs2 = NULL, bool tlIsSourceCode = true, bool tlRemoveWhitespaces = true);
