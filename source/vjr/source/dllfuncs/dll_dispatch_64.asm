...
//////////
			...
			_asm
			{
				...
				//////
					...
					mov		r12,lnParamCount			// lnParamCount		= dfunc->ipCount
					mov		r13,types_base				// typePtr			= &types[lnParamCount - 1]
					mov		r14,pointers_base			// pointersPtr		= &pointers[lnParamCount - 1]
					mov		r15,values_base				// valuesPtr		= &values[lnParamCount - 1]
					jmp		push_next_param

prepare_for_next_param:
					// incrementPart
					dec		r12							// lnParamCount--
					sub		r13,lnSizeofTypes			// --typePtr
					sub		r14,lnSizeofPointers		// --pointersPtr
					sub		r15,lnSizeofValues			// --valuesPtr
...
push_integer_onto_stack:
					...
					add		lnSaveParamBytes,8			// Increase the bytes on the stack
...
push_f32_onto_stack:
					...
					add		lnSaveParamBytes,4			// Increase the bytes on the stack
					jmp		prepare_for_next_param		// Continue on
