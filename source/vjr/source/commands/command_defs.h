...
//
//////
	void				function_abs		/* Stefano D'Amico */	(SFunctionParams* rpar);
	void				function_acos		/* Stefano D'Amico */	(SFunctionParams* rpar);
	void				function_addbs								(SFunctionParams* rpar);
	void				function_alltrim							(SFunctionParams* rpar);
	void				ifunction_trim_common						(SFunctionParams* rpar, SVariable* varString, SVariable* varCaseInsensitive, SVariable* varTrimChars1, SVariable* varTrimChars2, bool trimStart, bool trimEnd);
	void				function_alp								(SFunctionParams* rpar);
	void				function_asc								(SFunctionParams* rpar);
	void				function_asin		/* Stefano D'Amico */	(SFunctionParams* rpar);
	void				function_at									(SFunctionParams* rpar);
	void				function_atan		/* Stefano D'Amico */	(SFunctionParams* rpar);
	...
	void				function_between	/* Stefano D'Amico */	(SFunctionParams* rpar);
	...
	void				function_cdow		/* Stefano D'Amico */	(SFunctionParams* rpar);
	u32					ifunction_dow_common						(SFunctionParams* rpar, u32 tnYear, u32 tnMonth, u32 tnDay);
	void				function_ceiling	/* Stefano D'Amico */	(SFunctionParams* rpar);
	void				function_chr								(SFunctionParams* rpar);
	void				function_chrtran							(SFunctionParams* rpar);
	void				function_chrtranc							(SFunctionParams* rpar);
	void				ifunction_chrtran_common					(SFunctionParams* rpar, SVariable* varString, SVariable* varSearch, SVariable* varReplace, bool tlCaseSensitive);
	void				function_cmonth		/* Stefano D'Amico */	(SFunctionParams* rpar);
	void				function_colorize							(SFunctionParams* rpar);
	void				ifunction_colorize_common					(SFunctionParams* rpar, SVariable* varColor, SVariable* varColorTarget, SVariable* varPercentage, bool tlApplyColorTarget);
	void				function_cos		/* Stefano D'Amico */	(SFunctionParams* rpar);
	void				function_createobject						(SFunctionParams* rpar);
	void				function_ctod								(SFunctionParams* rpar);
	void				ifunction_ctox_common						(SFunctionParams* rpar, SVariable* varString, bool tlIncludeTime);
	void				function_ctot								(SFunctionParams* rpar);
	void				function_curdir								(SFunctionParams* rpar);
	void				function_date		/* Stefano D'Amico */	(SFunctionParams* rpar);
	...
	void				function_day		/* Stefano D'Amico */	(SFunctionParams* rpar);
	void				ifunction_day_month_year_common				(SFunctionParams* rpar, SVariable* varParam, u32 tnFunctionType);
	void				function_difference	/* Stefano D'Amico */	(SFunctionParams* rpar);
	void				function_dmy		/* Stefano D'Amico */	(SFunctionParams* rpar);
	void				ifunction_dtoc_common						(SFunctionParams* rpar, SVariable* varParam, u32 tnFunctionType);
	void				function_dow		/* Hernan Cano */		(SFunctionParams* rpar);
	void				function_dtoc		/* Stefano D'Amico */	(SFunctionParams* rpar);
	void				function_dtor		/* Stefano D'Amico */	(SFunctionParams* rpar);
	void				function_dtos		/* Stefano D'Amico */	(SFunctionParams* rpar);
	void				function_dtot		/* Stefano D'Amico */	(SFunctionParams* rpar);
	void				function_dtox								(SFunctionParams* rpar);
	void				function_dtransform	/* Stefano D'Amico */	(SFunctionParams* rpar);
	...
	void				function_empty		/* Stefano D'Amico */	(SFunctionParams* rpar);
	...
	void				function_evl		/* Stefano D'Amico */	(SFunctionParams* rpar);
	void				function_exp		/* Stefano D'Amico */	(SFunctionParams* rpar);
	...
	void				function_floor		/* Stefano D'Amico */	(SFunctionParams* rpar);
	void				function_forceext	/* Stefano D'Amico */	(SFunctionParams* rpar);
	bool				ifunction_pathname_common					(SFunctionParams* rpar, SVariable* varPathname, s32* tnFNamePos, s32* tnExtPos);
	void				function_forcefname	/* Stefano D'Amico */	(SFunctionParams* rpar);
	void				function_forcepath	/* Stefano D'Amico */	(SFunctionParams* rpar);
	void				function_forcestem	/* Stefano D'Amico */	(SFunctionParams* rpar);
	void				function_fv			/* Stefano D'Amico */	(SFunctionParams* rpar);
	SVariable*			ifunction_getword_common					(SVariable* varStr, SDatum delimiters, s32 tnIndex, bool tlCount);
	void				function_getwordcount/* Stefano D'Amico */	(SFunctionParams* rpar);
	void				function_getwordnum	/* Stefano D'Amico */	(SFunctionParams* rpar);
	void				function_gomonth	/* Stefano D'Amico */	(SFunctionParams* rpar);
	void				function_grayscale							(SFunctionParams* rpar);
	void				function_grn								(SFunctionParams* rpar);
	void				function_hour		/* Stefano D'Amico */	(SFunctionParams* rpar);
	...
	void				function_isalpha	/* Stefano D'Amico */	(SFunctionParams* rpar);
	void				function_isdigit	/* Stefano D'Amico */	(SFunctionParams* rpar);
	void				function_islower	/* Stefano D'Amico */	(SFunctionParams* rpar);
	void				function_isupper	/* Stefano D'Amico */	(SFunctionParams* rpar);
	void				function_isnull		/* Hernan Cano */		(SFunctionParams* rpar);
	...
	void				function_like		/* Stefano D'Amico */	(SFunctionParams* rpar);
	void				function_log		/* Stefano D'Amico */	(SFunctionParams* rpar);
	void				function_log10		/* Stefano D'Amico */	(SFunctionParams* rpar);
	...
	void				function_mdy		/* Stefano D'Amico */	(SFunctionParams* rpar);
	void				function_microsecond						(SFunctionParams* rpar);
	void				function_min								(SFunctionParams* rpar);
	void				function_minute		/* Stefano D'Amico */	(SFunctionParams* rpar);
	void				function_mod		/* Stefano D'Amico */	(SFunctionParams* rpar);
	void				function_month		/* Stefano D'Amico */	(SFunctionParams* rpar);
	void				function_nanosecond							(SFunctionParams* rpar);
	void				function_ncset								(SFunctionParams* rpar);
	void				function_nvl		/* Hernan Cano */		(SFunctionParams* rpar);
	void				function_occurs								(SFunctionParams* rpar);
	void				function_occursc							(SFunctionParams* rpar);
	void				function_outside	/* Stefano D'Amico */	(SFunctionParams* rpar);
	...
	void				function_payment	/* Stefano D'Amico */	(SFunctionParams* rpar);
	void				function_pi			/* Stefano D'Amico */	(SFunctionParams* rpar);
	void				function_pow		/* Stefano D'Amico */	(SFunctionParams* rpar);
	void				function_proper								(SFunctionParams* rpar);
	void				function_pv			/* Stefano D'Amico */	(SFunctionParams* rpar);
	void				function_quarter	/* Stefano D'Amico */	(SFunctionParams* rpar);
	void				function_ranger		/* Stefano D'Amico */	(SFunctionParams* rpar);
	...
	void				function_round		/* Stefano D'Amico */	(SFunctionParams* rpar);
	void				function_rtod		/* Stefano D'Amico */	(SFunctionParams* rpar);
	void				function_rtrim								(SFunctionParams* rpar);
	void				function_sec		/* Stefano D'Amico */	(SFunctionParams* rpar);
	void				function_seconds	/* Stefano D'Amico */	(SFunctionParams* rpar);
	...
	void				function_sign		/* Stefano D'Amico */	(SFunctionParams* rpar);
	...
	void				function_sin		/* Stefano D'Amico */	(SFunctionParams* rpar);
	void				function_slice								(SFunctionParams* rpar);
	void				function_soundex	/* Stefano D'Amico */	(SFunctionParams* rpar);
	SVariable*			ifunction_soundex_common					(SVariable* varString);
	void				function_space								(SFunctionParams* rpar);
	void				function_sqrt		/* Stefano D'Amico */	(SFunctionParams* rpar);
	...
	SVariable*			iFunction_sys2015							(u32 tnPrefixWidth, u32 tnPostfixWidth, SFunctionParams* rpar);
	void				function_sysmetric							(SFunctionParams* rpar);
	void				function_tan		/* Stefano D'Amico */	(SFunctionParams* rpar);
	void				function__test								(SFunctionParams* rpar);
	void				function_textmerge							(SFunctionParams* rpar);
	void				function_time		/* Hernan Cano */		(SFunctionParams* rpar);
	...
	void				function_ttoc		/* Stefano D'Amico */	(SFunctionParams* rpar);
	void				function_ttod		/* Stefano D'Amico */	(SFunctionParams* rpar);
	...
	void				function_val		/* Stefano D'Amico */	(SFunctionParams* rpar);
	...
	void				function_week		/* Stefano D'Amico */	(SFunctionParams* rpar);
	...
	void				function_year		/* Stefano D'Amico */	(SFunctionParams* rpar);
...
//////
	...
	// May.17.2015 -- Functions Rick is currently working on, see rick_in_progress.cpp
	void				command_report								(SComp* compCommand, SFunctionParams* rpar);
...
//////
	struct SFunctionData
	{
		...
		//////
			union {
				uptr		_func;
				void		(*func)		(SFunctionParams* rpar);
			};
...
//////
	struct SCommandData
	{
		...
		//////
			union {
				uptr		_command;
				void		(*command)		(SComp* comp, SFunctionParams* rpar);
			};
