//////////
//
// /libsf/exodus/tools/debi/debi_defs.h
//
//////
// Version 0.80
...
//////
	...
	void	do_common_m									(u8* data, SDisasmData* dd, u32/*REGTYPE*/ rt, u8* prefix_op1);
	...
	void	do_immediate								(u8* data, SDisasmData* dd, u32/*REGTYPE*/ rt, u8* prefix_op1);
	...
	void	do_common_two_prefixes_mnemonic_operand_size_check(SDisasmData* dd, u32 opcode_length,  u32 prefix1, u8* mnemonic1, u32 prefix2, u8* mnemonic2, u8* _16bit_operand, u8* _32bit_operand);
