...
//////
	...
	#define	iEncodeBranch(i)		((u32)i << 24)
	#define	iCodeBranch(i)			(((u32)i & 0xff00000) >> 24)
	#define	iAddress(a)				(uptr)&ilsa_pass3_##a

	cs32	_ICODE_LSA_AAA							= iEncodeBranch(1) + 3000000;
	cs32	_ICODE_LSA_AAD							= iEncodeBranch(2) + 3000000;
	cs32	_ICODE_LSA_AAD2							= iEncodeBranch(3) + 3000000;
	cs32	_ICODE_LSA_AAM							= iEncodeBranch(4) + 3000000;
	cs32	_ICODE_LSA_AAM2							= iEncodeBranch(5) + 3000000;
	cs32	_ICODE_LSA_AAS							= iEncodeBranch(6) + 3000000;
	cs32	_ICODE_LSA_ADC							= iEncodeBranch(7) + 3000000;
	cs32	_ICODE_LSA_ADD							= iEncodeBranch(8) + 3000000;
	cs32	_ICODE_LSA_AND							= iEncodeBranch(9) + 3000000;
	cs32	_ICODE_LSA_APRL							= iEncodeBranch(10) + 3000000;
	cs32	_ICODE_LSA_BOUND						= iEncodeBranch(11) + 3000000;
	cs32	_ICODE_LSA_BSF							= iEncodeBranch(12) + 3000000;
	cs32	_ICODE_LSA_BSR							= iEncodeBranch(13) + 3000000;
	cs32	_ICODE_LSA_BSWAP						= iEncodeBranch(14) + 3000000;
	cs32	_ICODE_LSA_BT							= iEncodeBranch(15) + 3000000;
	cs32	_ICODE_LSA_BTC							= iEncodeBranch(16) + 3000000;
	cs32	_ICODE_LSA_BTR							= iEncodeBranch(17) + 3000000;
	cs32	_ICODE_LSA_BTS							= iEncodeBranch(18) + 3000000;
	cs32	_ICODE_LSA_CALL							= iEncodeBranch(19) + 3000000;
	cs32	_ICODE_LSA_CBW							= iEncodeBranch(20) + 3000000;
	cs32	_ICODE_LSA_CWDE							= iEncodeBranch(21) + 3000000;
	cs32	_ICODE_LSA_CLC							= iEncodeBranch(22) + 3000000;
	cs32	_ICODE_LSA_CLD							= iEncodeBranch(23) + 3000000;
	cs32	_ICODE_LSA_CLI							= iEncodeBranch(24) + 3000000;
	cs32	_ICODE_LSA_CLTS							= iEncodeBranch(25) + 3000000;
	cs32	_ICODE_LSA_CMOVCC						= iEncodeBranch(26) + 3000000;
	cs32	_ICODE_LSA_CMP							= iEncodeBranch(27) + 3000000;
	cs32	_ICODE_LSA_CMPSB						= iEncodeBranch(28) + 3000000;
	cs32	_ICODE_LSA_CMPSW						= iEncodeBranch(29) + 3000000;
	cs32	_ICODE_LSA_CMPSD						= iEncodeBranch(30) + 3000000;
	cs32	_ICODE_LSA_CMPXCHG						= iEncodeBranch(31) + 3000000;
	cs32	_ICODE_LSA_CMPXCHG8B					= iEncodeBranch(32) + 3000000;
	cs32	_ICODE_LSA_CPUID						= iEncodeBranch(33) + 3000000;
	cs32	_ICODE_LSA_CDW							= iEncodeBranch(34) + 3000000;
	cs32	_ICODE_LSA_CDQ							= iEncodeBranch(35) + 3000000;
	cs32	_ICODE_LSA_DAA							= iEncodeBranch(36) + 3000000;
	cs32	_ICODE_LSA_DAS							= iEncodeBranch(37) + 3000000;
	cs32	_ICODE_LSA_DEC							= iEncodeBranch(38) + 3000000;
	cs32	_ICODE_LSA_DIV							= iEncodeBranch(39) + 3000000;
	cs32	_ICODE_LSA_EMMS							= iEncodeBranch(40) + 3000000;
	cs32	_ICODE_LSA_ENTER						= iEncodeBranch(41) + 3000000;
	cs32	_ICODE_LSA_F2XM1						= iEncodeBranch(42) + 3000000;
	cs32	_ICODE_LSA_FABS							= iEncodeBranch(43) + 3000000;
	cs32	_ICODE_LSA_FADD							= iEncodeBranch(44) + 3000000;
	cs32	_ICODE_LSA_FADDP						= iEncodeBranch(45) + 3000000;
	cs32	_ICODE_LSA_FIADD						= iEncodeBranch(46) + 3000000;
	cs32	_ICODE_LSA_FBLD							= iEncodeBranch(47) + 3000000;
	cs32	_ICODE_LSA_FBSTP						= iEncodeBranch(48) + 3000000;
	cs32	_ICODE_LSA_FCHS							= iEncodeBranch(49) + 3000000;
	cs32	_ICODE_LSA_FCLEX						= iEncodeBranch(50) + 3000000;
	cs32	_ICODE_LSA_FNCLEX						= iEncodeBranch(51) + 3000000;
	cs32	_ICODE_LSA_FCMOVB						= iEncodeBranch(52) + 3000000;
	cs32	_ICODE_LSA_FCMOVE						= iEncodeBranch(53) + 3000000;
	cs32	_ICODE_LSA_FCMOVBE						= iEncodeBranch(54) + 3000000;
	cs32	_ICODE_LSA_FCMOVU						= iEncodeBranch(55) + 3000000;
	cs32	_ICODE_LSA_FCMOVNB						= iEncodeBranch(56) + 3000000;
	cs32	_ICODE_LSA_FCMOVNE						= iEncodeBranch(57) + 3000000;
	cs32	_ICODE_LSA_FCMOVNBE						= iEncodeBranch(58) + 3000000;
	cs32	_ICODE_LSA_FCMOVNU						= iEncodeBranch(59) + 3000000;
	cs32	_ICODE_LSA_FCOM							= iEncodeBranch(60) + 3000000;
	cs32	_ICODE_LSA_FCOMP						= iEncodeBranch(61) + 3000000;
	cs32	_ICODE_LSA_FCOMPP						= iEncodeBranch(62) + 3000000;
	cs32	_ICODE_LSA_FCOMI						= iEncodeBranch(63) + 3000000;
	cs32	_ICODE_LSA_FCOMIP						= iEncodeBranch(64) + 3000000;
	cs32	_ICODE_LSA_FUCOMI						= iEncodeBranch(65) + 3000000;
	cs32	_ICODE_LSA_FUCOMIP						= iEncodeBranch(66) + 3000000;
	cs32	_ICODE_LSA_FCOS							= iEncodeBranch(67) + 3000000;
	cs32	_ICODE_LSA_FDECSTP						= iEncodeBranch(68) + 3000000;
	cs32	_ICODE_LSA_FDIV							= iEncodeBranch(69) + 3000000;
	cs32	_ICODE_LSA_FDIVP						= iEncodeBranch(70) + 3000000;
	cs32	_ICODE_LSA_FIDIV						= iEncodeBranch(71) + 3000000;
	cs32	_ICODE_LSA_FDIVR						= iEncodeBranch(72) + 3000000;
	cs32	_ICODE_LSA_FDIVRP						= iEncodeBranch(73) + 3000000;
	cs32	_ICODE_LSA_FIDIVR						= iEncodeBranch(74) + 3000000;
	cs32	_ICODE_LSA_FFREE						= iEncodeBranch(75) + 3000000;
	cs32	_ICODE_LSA_FICOM						= iEncodeBranch(76) + 3000000;
	cs32	_ICODE_LSA_FICOMP						= iEncodeBranch(77) + 3000000;
	cs32	_ICODE_LSA_FILD							= iEncodeBranch(78) + 3000000;
	cs32	_ICODE_LSA_FINCSTP						= iEncodeBranch(79) + 3000000;
	cs32	_ICODE_LSA_FINIT						= iEncodeBranch(80) + 3000000;
	cs32	_ICODE_LSA_FIST							= iEncodeBranch(81) + 3000000;
	cs32	_ICODE_LSA_FISTP						= iEncodeBranch(82) + 3000000;
	cs32	_ICODE_LSA_FLD							= iEncodeBranch(83) + 3000000;
	cs32	_ICODE_LSA_FLD1							= iEncodeBranch(84) + 3000000;
	cs32	_ICODE_LSA_FLD2T						= iEncodeBranch(85) + 3000000;
	cs32	_ICODE_LSA_FLD2E						= iEncodeBranch(86) + 3000000;
	cs32	_ICODE_LSA_FLDPI						= iEncodeBranch(87) + 3000000;
	cs32	_ICODE_LSA_FLDLG2						= iEncodeBranch(88) + 3000000;
	cs32	_ICODE_LSA_FLDN2						= iEncodeBranch(89) + 3000000;
	cs32	_ICODE_LSA_FLDZ							= iEncodeBranch(90) + 3000000;
	cs32	_ICODE_LSA_FLDCW						= iEncodeBranch(91) + 3000000;
	cs32	_ICODE_LSA_FLDENV						= iEncodeBranch(92) + 3000000;
	cs32	_ICODE_LSA_FMUL							= iEncodeBranch(93) + 3000000;
	cs32	_ICODE_LSA_FMULP						= iEncodeBranch(94) + 3000000;
	cs32	_ICODE_LSA_FIMUL						= iEncodeBranch(95) + 3000000;
	cs32	_ICODE_LSA_FNOP							= iEncodeBranch(96) + 3000000;
	cs32	_ICODE_LSA_FPATAN						= iEncodeBranch(97) + 3000000;
	cs32	_ICODE_LSA_FPREM						= iEncodeBranch(98) + 3000000;
	cs32	_ICODE_LSA_FPREM1						= iEncodeBranch(99) + 3000000;
	cs32	_ICODE_LSA_FPTAN						= iEncodeBranch(100) + 3000000;
	cs32	_ICODE_LSA_FRNDINT						= iEncodeBranch(101) + 3000000;
	cs32	_ICODE_LSA_FRSTOR						= iEncodeBranch(102) + 3000000;
	cs32	_ICODE_LSA_FSAVE						= iEncodeBranch(103) + 3000000;
	cs32	_ICODE_LSA_FSCALE						= iEncodeBranch(104) + 3000000;
	cs32	_ICODE_LSA_FSIN							= iEncodeBranch(105) + 3000000;
	cs32	_ICODE_LSA_FSINCOS						= iEncodeBranch(106) + 3000000;
	cs32	_ICODE_LSA_FSQRT						= iEncodeBranch(107) + 3000000;
	cs32	_ICODE_LSA_FST							= iEncodeBranch(108) + 3000000;
	cs32	_ICODE_LSA_FSTCW						= iEncodeBranch(109) + 3000000;
	cs32	_ICODE_LSA_FSTENV						= iEncodeBranch(110) + 3000000;
	cs32	_ICODE_LSA_FSTSW						= iEncodeBranch(111) + 3000000;
	cs32	_ICODE_LSA_FSUB							= iEncodeBranch(112) + 3000000;
	cs32	_ICODE_LSA_FSUBP						= iEncodeBranch(113) + 3000000;
	cs32	_ICODE_LSA_FISUB						= iEncodeBranch(114) + 3000000;
	cs32	_ICODE_LSA_FSUBR						= iEncodeBranch(115) + 3000000;
	cs32	_ICODE_LSA_FSUBRP						= iEncodeBranch(116) + 3000000;
	cs32	_ICODE_LSA_FISUBR						= iEncodeBranch(117) + 3000000;
	cs32	_ICODE_LSA_FTST							= iEncodeBranch(118) + 3000000;
	cs32	_ICODE_LSA_FUCOM						= iEncodeBranch(119) + 3000000;
	cs32	_ICODE_LSA_FUCOMP						= iEncodeBranch(120) + 3000000;
	cs32	_ICODE_LSA_FUCOMPP						= iEncodeBranch(121) + 3000000;
	cs32	_ICODE_LSA_FXAM							= iEncodeBranch(122) + 3000000;
	cs32	_ICODE_LSA_FXCH							= iEncodeBranch(123) + 3000000;
	cs32	_ICODE_LSA_FXTRACT						= iEncodeBranch(124) + 3000000;
	cs32	_ICODE_LSA_FYL2X						= iEncodeBranch(125) + 3000000;
	cs32	_ICODE_LSA_FYL2XP1						= iEncodeBranch(126) + 3000000;
	cs32	_ICODE_LSA_HLT							= iEncodeBranch(127) + 3000000;
	cs32	_ICODE_LSA_IDIV							= iEncodeBranch(128) + 3000000;
	cs32	_ICODE_LSA_IMUL							= iEncodeBranch(129) + 3000000;
	cs32	_ICODE_LSA_IN							= iEncodeBranch(130) + 3000000;
	cs32	_ICODE_LSA_INC							= iEncodeBranch(131) + 3000000;
	cs32	_ICODE_LSA_INS							= iEncodeBranch(132) + 3000000;
	cs32	_ICODE_LSA_INSB							= iEncodeBranch(133) + 3000000;
	cs32	_ICODE_LSA_INSW							= iEncodeBranch(134) + 3000000;
	cs32	_ICODE_LSA_INSD							= iEncodeBranch(135) + 3000000;
	cs32	_ICODE_LSA_INT3							= iEncodeBranch(136) + 3000000;
	cs32	_ICODE_LSA_INT							= iEncodeBranch(137) + 3000000;
	cs32	_ICODE_LSA_INTO							= iEncodeBranch(138) + 3000000;
	cs32	_ICODE_LSA_INVD							= iEncodeBranch(139) + 3000000;
	cs32	_ICODE_LSA_INVLPG						= iEncodeBranch(140) + 3000000;
	cs32	_ICODE_LSA_IRET							= iEncodeBranch(141) + 3000000;
	cs32	_ICODE_LSA_IRETD						= iEncodeBranch(142) + 3000000;
	cs32	_ICODE_LSA_JCC							= iEncodeBranch(143) + 3000000;
	cs32	_ICODE_LSA_JMP							= iEncodeBranch(144) + 3000000;
	cs32	_ICODE_LSA_LAHF							= iEncodeBranch(145) + 3000000;
	cs32	_ICODE_LSA_LAR							= iEncodeBranch(146) + 3000000;
	cs32	_ICODE_LSA_LDS							= iEncodeBranch(147) + 3000000;
	cs32	_ICODE_LSA_LSS							= iEncodeBranch(148) + 3000000;
	cs32	_ICODE_LSA_LES							= iEncodeBranch(149) + 3000000;
	cs32	_ICODE_LSA_LFS							= iEncodeBranch(150) + 3000000;
	cs32	_ICODE_LSA_LGS							= iEncodeBranch(151) + 3000000;
	cs32	_ICODE_LSA_LEA							= iEncodeBranch(152) + 3000000;
	cs32	_ICODE_LSA_LEAVE						= iEncodeBranch(153) + 3000000;
	cs32	_ICODE_LSA_LGDT							= iEncodeBranch(154) + 3000000;
	cs32	_ICODE_LSA_LIDT							= iEncodeBranch(155) + 3000000;
	cs32	_ICODE_LSA_LLDT							= iEncodeBranch(156) + 3000000;
	cs32	_ICODE_LSA_LMSW							= iEncodeBranch(157) + 3000000;
	cs32	_ICODE_LSA_LOCK							= iEncodeBranch(158) + 3000000;
	cs32	_ICODE_LSA_LODS							= iEncodeBranch(159) + 3000000;
	cs32	_ICODE_LSA_LODSB						= iEncodeBranch(160) + 3000000;
	cs32	_ICODE_LSA_LODSW						= iEncodeBranch(161) + 3000000;
	cs32	_ICODE_LSA_LODSD						= iEncodeBranch(162) + 3000000;
	cs32	_ICODE_LSA_LOOP							= iEncodeBranch(163) + 3000000;
	cs32	_ICODE_LSA_LOOPE						= iEncodeBranch(164) + 3000000;
	cs32	_ICODE_LSA_LOOPZ						= iEncodeBranch(165) + 3000000;
	cs32	_ICODE_LSA_LOOPNE						= iEncodeBranch(166) + 3000000;
	cs32	_ICODE_LSA_LOOPNZ						= iEncodeBranch(167) + 3000000;
	cs32	_ICODE_LSA_LSL							= iEncodeBranch(168) + 3000000;
	cs32	_ICODE_LSA_LTR							= iEncodeBranch(169) + 3000000;
	cs32	_ICODE_LSA_MOV							= iEncodeBranch(170) + 3000000;
	cs32	_ICODE_LSA_MOVS							= iEncodeBranch(171) + 3000000;
	cs32	_ICODE_LSA_MOVSB						= iEncodeBranch(172) + 3000000;
	cs32	_ICODE_LSA_MOVSW						= iEncodeBranch(173) + 3000000;
	cs32	_ICODE_LSA_MOVSD						= iEncodeBranch(174) + 3000000;
	cs32	_ICODE_LSA_MOVSX						= iEncodeBranch(175) + 3000000;
	cs32	_ICODE_LSA_MOVZX						= iEncodeBranch(176) + 3000000;
	cs32	_ICODE_LSA_MUL							= iEncodeBranch(177) + 3000000;
	cs32	_ICODE_LSA_NEG							= iEncodeBranch(178) + 3000000;
	cs32	_ICODE_LSA_NOP							= iEncodeBranch(179) + 3000000;
	cs32	_ICODE_LSA_NOT							= iEncodeBranch(180) + 3000000;
	cs32	_ICODE_LSA_OR							= iEncodeBranch(181) + 3000000;
	cs32	_ICODE_LSA_OUT							= iEncodeBranch(182) + 3000000;
	cs32	_ICODE_LSA_OUTS							= iEncodeBranch(183) + 3000000;
	cs32	_ICODE_LSA_OUTSB						= iEncodeBranch(184) + 3000000;
	cs32	_ICODE_LSA_OUTSW						= iEncodeBranch(185) + 3000000;
	cs32	_ICODE_LSA_OUTSD						= iEncodeBranch(186) + 3000000;
	cs32	_ICODE_LSA_POP							= iEncodeBranch(187) + 3000000;
	cs32	_ICODE_LSA_POPA							= iEncodeBranch(188) + 3000000;
	cs32	_ICODE_LSA_POPAD						= iEncodeBranch(189) + 3000000;
	cs32	_ICODE_LSA_POPF							= iEncodeBranch(190) + 3000000;
	cs32	_ICODE_LSA_POPFD						= iEncodeBranch(191) + 3000000;
	cs32	_ICODE_LSA_PREFETCH0					= iEncodeBranch(192) + 3000000;
	cs32	_ICODE_LSA_PREFETCH1					= iEncodeBranch(193) + 3000000;
	cs32	_ICODE_LSA_PREFETCH2					= iEncodeBranch(194) + 3000000;
	cs32	_ICODE_LSA_PREFETCHNTA					= iEncodeBranch(195) + 3000000;
	cs32	_ICODE_LSA_PUSH							= iEncodeBranch(196) + 3000000;
	cs32	_ICODE_LSA_PUSHA						= iEncodeBranch(197) + 3000000;
	cs32	_ICODE_LSA_PUSHAD						= iEncodeBranch(198) + 3000000;
	cs32	_ICODE_LSA_PUSHF						= iEncodeBranch(199) + 3000000;
	cs32	_ICODE_LSA_PUSHFD						= iEncodeBranch(200) + 3000000;
	cs32	_ICODE_LSA_RCL							= iEncodeBranch(201) + 3000000;
	cs32	_ICODE_LSA_RCR							= iEncodeBranch(202) + 3000000;
	cs32	_ICODE_LSA_REPNE						= iEncodeBranch(203) + 3000000;
	cs32	_ICODE_LSA_REPNZ						= iEncodeBranch(204) + 3000000;
	cs32	_ICODE_LSA_REPE							= iEncodeBranch(205) + 3000000;
	cs32	_ICODE_LSA_REPZ							= iEncodeBranch(206) + 3000000;
	cs32	_ICODE_LSA_ROL							= iEncodeBranch(207) + 3000000;
	cs32	_ICODE_LSA_ROR							= iEncodeBranch(208) + 3000000;
	cs32	_ICODE_LSA_RDMSR						= iEncodeBranch(209) + 3000000;
	cs32	_ICODE_LSA_RDPMC						= iEncodeBranch(210) + 3000000;
	cs32	_ICODE_LSA_RDTSC						= iEncodeBranch(211) + 3000000;
	cs32	_ICODE_LSA_RET							= iEncodeBranch(212) + 3000000;
	cs32	_ICODE_LSA_SAHF							= iEncodeBranch(213) + 3000000;
	cs32	_ICODE_LSA_SAR							= iEncodeBranch(214) + 3000000;
	cs32	_ICODE_LSA_SHL							= iEncodeBranch(215) + 3000000;
	cs32	_ICODE_LSA_SHR							= iEncodeBranch(216) + 3000000;
	cs32	_ICODE_LSA_SBB							= iEncodeBranch(217) + 3000000;
	cs32	_ICODE_LSA_SCAS							= iEncodeBranch(218) + 3000000;
	cs32	_ICODE_LSA_SCASB						= iEncodeBranch(219) + 3000000;
	cs32	_ICODE_LSA_SCASW						= iEncodeBranch(220) + 3000000;
	cs32	_ICODE_LSA_SCASD						= iEncodeBranch(221) + 3000000;
	cs32	_ICODE_LSA_SETCC						= iEncodeBranch(222) + 3000000;
	cs32	_ICODE_LSA_SGDT							= iEncodeBranch(223) + 3000000;
	cs32	_ICODE_LSA_SIDT							= iEncodeBranch(224) + 3000000;
	cs32	_ICODE_LSA_SLDT							= iEncodeBranch(225) + 3000000;
	cs32	_ICODE_LSA_SHLD							= iEncodeBranch(226) + 3000000;
	cs32	_ICODE_LSA_SHRD							= iEncodeBranch(227) + 3000000;
	cs32	_ICODE_LSA_SMSW							= iEncodeBranch(228) + 3000000;
	cs32	_ICODE_LSA_STC							= iEncodeBranch(229) + 3000000;
	cs32	_ICODE_LSA_STD							= iEncodeBranch(230) + 3000000;
	cs32	_ICODE_LSA_STI							= iEncodeBranch(231) + 3000000;
	cs32	_ICODE_LSA_STOS							= iEncodeBranch(232) + 3000000;
	cs32	_ICODE_LSA_STOSB						= iEncodeBranch(233) + 3000000;
	cs32	_ICODE_LSA_STOSW						= iEncodeBranch(234) + 3000000;
	cs32	_ICODE_LSA_STOSD						= iEncodeBranch(235) + 3000000;
	cs32	_ICODE_LSA_STR							= iEncodeBranch(236) + 3000000;
	cs32	_ICODE_LSA_SUB							= iEncodeBranch(237) + 3000000;
	cs32	_ICODE_LSA_SYSENTER						= iEncodeBranch(238) + 3000000;
	cs32	_ICODE_LSA_SYSEXIT						= iEncodeBranch(239) + 3000000;
	cs32	_ICODE_LSA_TEST							= iEncodeBranch(240) + 3000000;
	cs32	_ICODE_LSA_UD2							= iEncodeBranch(241) + 3000000;
	cs32	_ICODE_LSA_VERR							= iEncodeBranch(242) + 3000000;
	cs32	_ICODE_LSA_VERW							= iEncodeBranch(243) + 3000000;
	cs32	_ICODE_LSA_FWAIT						= iEncodeBranch(244) + 3000000;
	cs32	_ICODE_LSA_WBINVD						= iEncodeBranch(245) + 3000000;
	cs32	_ICODE_LSA_WRMSR						= iEncodeBranch(246) + 3000000;
	cs32	_ICODE_LSA_XADD							= iEncodeBranch(247) + 3000000;
	cs32	_ICODE_LSA_XCHG							= iEncodeBranch(248) + 3000000;
	cs32	_ICODE_LSA_XLAT							= iEncodeBranch(249) + 3000000;
	cs32	_ICODE_LSA_XLATB						= iEncodeBranch(250) + 3000000;
	cs32	_ICODE_LSA_XOR							= iEncodeBranch(251) + 3000000;
