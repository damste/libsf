...
#define	iDecodeBranch(i)		(((u32)i & 0xff000000) >> 24)
...
cs32	_ICODE_LSA_CMOVNO						= iEncodeBranch(27);
cs32	_ICODE_LSA_CMOVB						= iEncodeBranch(28);
cs32	_ICODE_LSA_CMOVNAE						= iEncodeBranch(29);
cs32	_ICODE_LSA_CMOVAE						= iEncodeBranch(30);
cs32	_ICODE_LSA_CMOVNB						= iEncodeBranch(31);
cs32	_ICODE_LSA_CMOVZ						= iEncodeBranch(32);
cs32	_ICODE_LSA_CMOVE						= iEncodeBranch(33);
cs32	_ICODE_LSA_CMOVNZ						= iEncodeBranch(34);
cs32	_ICODE_LSA_CMOVNE						= iEncodeBranch(35);
cs32	_ICODE_LSA_CMOVNA						= iEncodeBranch(36);
cs32	_ICODE_LSA_CMOVBE						= iEncodeBranch(37);
cs32	_ICODE_LSA_CMOVA						= iEncodeBranch(38);
cs32	_ICODE_LSA_CMOVNBE						= iEncodeBranch(39);
cs32	_ICODE_LSA_CMOVS						= iEncodeBranch(40);
cs32	_ICODE_LSA_CMOVNS						= iEncodeBranch(41);
cs32	_ICODE_LSA_CMOVP						= iEncodeBranch(42);
cs32	_ICODE_LSA_CMOVPE						= iEncodeBranch(43);
cs32	_ICODE_LSA_CMOVNP						= iEncodeBranch(44);
cs32	_ICODE_LSA_CMOVPO						= iEncodeBranch(45);
cs32	_ICODE_LSA_CMOVL						= iEncodeBranch(46);
cs32	_ICODE_LSA_CMOVNGE						= iEncodeBranch(47);
cs32	_ICODE_LSA_CMOVGE						= iEncodeBranch(48);
cs32	_ICODE_LSA_CMOVNL						= iEncodeBranch(49);
cs32	_ICODE_LSA_CMOVLE						= iEncodeBranch(50);
cs32	_ICODE_LSA_CMOVNG						= iEncodeBranch(51);
cs32	_ICODE_LSA_CMOVG						= iEncodeBranch(52);
cs32	_ICODE_LSA_CMOVNLE						= iEncodeBranch(53);
cs32	_ICODE_LSA_CMP							= iEncodeBranch(54);
cs32	_ICODE_LSA_CMPSB						= iEncodeBranch(55);
cs32	_ICODE_LSA_CMPSW						= iEncodeBranch(56);
cs32	_ICODE_LSA_CMPSD						= iEncodeBranch(57);
cs32	_ICODE_LSA_CMPXCHG						= iEncodeBranch(58);
cs32	_ICODE_LSA_CMPXCHG8B					= iEncodeBranch(59);
cs32	_ICODE_LSA_CPUID						= iEncodeBranch(60);
cs32	_ICODE_LSA_CDW							= iEncodeBranch(61);
cs32	_ICODE_LSA_CDQ							= iEncodeBranch(62);
cs32	_ICODE_LSA_DAA							= iEncodeBranch(63);
cs32	_ICODE_LSA_DAS							= iEncodeBranch(64);
cs32	_ICODE_LSA_DEC							= iEncodeBranch(65);
cs32	_ICODE_LSA_DIV							= iEncodeBranch(66);
cs32	_ICODE_LSA_EMMS							= iEncodeBranch(67);
cs32	_ICODE_LSA_ENTER						= iEncodeBranch(68);
cs32	_ICODE_LSA_F2XM1						= iEncodeBranch(69);
cs32	_ICODE_LSA_FABS							= iEncodeBranch(70);
cs32	_ICODE_LSA_FADD							= iEncodeBranch(71);
cs32	_ICODE_LSA_FADDP						= iEncodeBranch(72);
cs32	_ICODE_LSA_FIADD						= iEncodeBranch(73);
cs32	_ICODE_LSA_FBLD							= iEncodeBranch(74);
cs32	_ICODE_LSA_FBSTP						= iEncodeBranch(75);
cs32	_ICODE_LSA_FCHS							= iEncodeBranch(76);
cs32	_ICODE_LSA_FCLEX						= iEncodeBranch(77);
cs32	_ICODE_LSA_FNCLEX						= iEncodeBranch(78);
cs32	_ICODE_LSA_FCMOVB						= iEncodeBranch(79);
cs32	_ICODE_LSA_FCMOVE						= iEncodeBranch(80);
cs32	_ICODE_LSA_FCMOVBE						= iEncodeBranch(81);
cs32	_ICODE_LSA_FCMOVU						= iEncodeBranch(82);
cs32	_ICODE_LSA_FCMOVNB						= iEncodeBranch(83);
cs32	_ICODE_LSA_FCMOVNE						= iEncodeBranch(84);
cs32	_ICODE_LSA_FCMOVNBE						= iEncodeBranch(85);
cs32	_ICODE_LSA_FCMOVNU						= iEncodeBranch(86);
cs32	_ICODE_LSA_FCOM							= iEncodeBranch(87);
cs32	_ICODE_LSA_FCOMP						= iEncodeBranch(88);
cs32	_ICODE_LSA_FCOMPP						= iEncodeBranch(89);
cs32	_ICODE_LSA_FCOMI						= iEncodeBranch(90);
cs32	_ICODE_LSA_FCOMIP						= iEncodeBranch(91);
cs32	_ICODE_LSA_FUCOMI						= iEncodeBranch(92);
cs32	_ICODE_LSA_FUCOMIP						= iEncodeBranch(93);
cs32	_ICODE_LSA_FCOS							= iEncodeBranch(94);
cs32	_ICODE_LSA_FDECSTP						= iEncodeBranch(95);
cs32	_ICODE_LSA_FDIV							= iEncodeBranch(96);
cs32	_ICODE_LSA_FDIVP						= iEncodeBranch(97);
cs32	_ICODE_LSA_FIDIV						= iEncodeBranch(98);
cs32	_ICODE_LSA_FDIVR						= iEncodeBranch(99);
cs32	_ICODE_LSA_FDIVRP						= iEncodeBranch(100);
cs32	_ICODE_LSA_FIDIVR						= iEncodeBranch(101);
cs32	_ICODE_LSA_FFREE						= iEncodeBranch(102);
cs32	_ICODE_LSA_FICOM						= iEncodeBranch(103);
cs32	_ICODE_LSA_FICOMP						= iEncodeBranch(104);
cs32	_ICODE_LSA_FILD							= iEncodeBranch(105);
cs32	_ICODE_LSA_FINCSTP						= iEncodeBranch(106);
cs32	_ICODE_LSA_FINIT						= iEncodeBranch(107);
cs32	_ICODE_LSA_FIST							= iEncodeBranch(108);
cs32	_ICODE_LSA_FISTP						= iEncodeBranch(109);
cs32	_ICODE_LSA_FLD							= iEncodeBranch(110);
cs32	_ICODE_LSA_FLD1							= iEncodeBranch(111);
cs32	_ICODE_LSA_FLD2T						= iEncodeBranch(112);
cs32	_ICODE_LSA_FLD2E						= iEncodeBranch(113);
cs32	_ICODE_LSA_FLDPI						= iEncodeBranch(114);
cs32	_ICODE_LSA_FLDLG2						= iEncodeBranch(115);
cs32	_ICODE_LSA_FLDN2						= iEncodeBranch(116);
cs32	_ICODE_LSA_FLDZ							= iEncodeBranch(117);
cs32	_ICODE_LSA_FLDCW						= iEncodeBranch(118);
cs32	_ICODE_LSA_FLDENV						= iEncodeBranch(119);
cs32	_ICODE_LSA_FMUL							= iEncodeBranch(120);
cs32	_ICODE_LSA_FMULP						= iEncodeBranch(121);
cs32	_ICODE_LSA_FIMUL						= iEncodeBranch(122);
cs32	_ICODE_LSA_FNOP							= iEncodeBranch(123);
cs32	_ICODE_LSA_FPATAN						= iEncodeBranch(124);
cs32	_ICODE_LSA_FPREM						= iEncodeBranch(125);
cs32	_ICODE_LSA_FPREM1						= iEncodeBranch(126);
cs32	_ICODE_LSA_FPTAN						= iEncodeBranch(127);
cs32	_ICODE_LSA_FRNDINT						= iEncodeBranch(128);
cs32	_ICODE_LSA_FRSTOR						= iEncodeBranch(129);
cs32	_ICODE_LSA_FSAVE						= iEncodeBranch(130);
cs32	_ICODE_LSA_FSCALE						= iEncodeBranch(131);
cs32	_ICODE_LSA_FSIN							= iEncodeBranch(132);
cs32	_ICODE_LSA_FSINCOS						= iEncodeBranch(133);
cs32	_ICODE_LSA_FSQRT						= iEncodeBranch(134);
cs32	_ICODE_LSA_FST							= iEncodeBranch(135);
cs32	_ICODE_LSA_FSTCW						= iEncodeBranch(136);
cs32	_ICODE_LSA_FSTENV						= iEncodeBranch(137);
cs32	_ICODE_LSA_FSTSW						= iEncodeBranch(138);
cs32	_ICODE_LSA_FSUB							= iEncodeBranch(139);
cs32	_ICODE_LSA_FSUBP						= iEncodeBranch(140);
cs32	_ICODE_LSA_FISUB						= iEncodeBranch(141);
cs32	_ICODE_LSA_FSUBR						= iEncodeBranch(142);
cs32	_ICODE_LSA_FSUBRP						= iEncodeBranch(143);
cs32	_ICODE_LSA_FISUBR						= iEncodeBranch(144);
cs32	_ICODE_LSA_FTST							= iEncodeBranch(145);
cs32	_ICODE_LSA_FUCOM						= iEncodeBranch(146);
cs32	_ICODE_LSA_FUCOMP						= iEncodeBranch(147);
cs32	_ICODE_LSA_FUCOMPP						= iEncodeBranch(148);
cs32	_ICODE_LSA_FXAM							= iEncodeBranch(149);
cs32	_ICODE_LSA_FXCH							= iEncodeBranch(150);
cs32	_ICODE_LSA_FXTRACT						= iEncodeBranch(151);
cs32	_ICODE_LSA_FYL2X						= iEncodeBranch(152);
cs32	_ICODE_LSA_FYL2XP1						= iEncodeBranch(153);
cs32	_ICODE_LSA_HLT							= iEncodeBranch(154);
cs32	_ICODE_LSA_IDIV							= iEncodeBranch(155);
cs32	_ICODE_LSA_IMUL							= iEncodeBranch(156);
cs32	_ICODE_LSA_IN							= iEncodeBranch(157);
cs32	_ICODE_LSA_INC							= iEncodeBranch(158);
cs32	_ICODE_LSA_INS							= iEncodeBranch(159);
cs32	_ICODE_LSA_INSB							= iEncodeBranch(160);
cs32	_ICODE_LSA_INSW							= iEncodeBranch(161);
cs32	_ICODE_LSA_INSD							= iEncodeBranch(162);
cs32	_ICODE_LSA_INT3							= iEncodeBranch(163);
cs32	_ICODE_LSA_INT							= iEncodeBranch(164);
cs32	_ICODE_LSA_INTO							= iEncodeBranch(165);
cs32	_ICODE_LSA_INVD							= iEncodeBranch(166);
cs32	_ICODE_LSA_INVLPG						= iEncodeBranch(167);
cs32	_ICODE_LSA_IRET							= iEncodeBranch(168);
cs32	_ICODE_LSA_IRETD						= iEncodeBranch(169);
cs32	_ICODE_LSA_JO							= iEncodeBranch(170);
cs32	_ICODE_LSA_JNO							= iEncodeBranch(171);
cs32	_ICODE_LSA_JB							= iEncodeBranch(172);
cs32	_ICODE_LSA_JNAE							= iEncodeBranch(173);
cs32	_ICODE_LSA_JAE							= iEncodeBranch(174);
cs32	_ICODE_LSA_JNB							= iEncodeBranch(175);
cs32	_ICODE_LSA_JZ							= iEncodeBranch(176);
cs32	_ICODE_LSA_JE							= iEncodeBranch(177);
cs32	_ICODE_LSA_JNZ							= iEncodeBranch(178);
cs32	_ICODE_LSA_JNE							= iEncodeBranch(179);
cs32	_ICODE_LSA_JNA							= iEncodeBranch(180);
cs32	_ICODE_LSA_JBE							= iEncodeBranch(181);
cs32	_ICODE_LSA_JA							= iEncodeBranch(182);
cs32	_ICODE_LSA_JNBE							= iEncodeBranch(183);
cs32	_ICODE_LSA_JS							= iEncodeBranch(184);
cs32	_ICODE_LSA_JNS							= iEncodeBranch(185);
cs32	_ICODE_LSA_JP							= iEncodeBranch(186);
cs32	_ICODE_LSA_JPE							= iEncodeBranch(187);
cs32	_ICODE_LSA_JNP							= iEncodeBranch(188);
cs32	_ICODE_LSA_JPO							= iEncodeBranch(189);
cs32	_ICODE_LSA_JL							= iEncodeBranch(190);
cs32	_ICODE_LSA_JNGE							= iEncodeBranch(191);
cs32	_ICODE_LSA_JGE							= iEncodeBranch(192);
cs32	_ICODE_LSA_JNL							= iEncodeBranch(193);
cs32	_ICODE_LSA_JLE							= iEncodeBranch(194);
cs32	_ICODE_LSA_JNG							= iEncodeBranch(195);
cs32	_ICODE_LSA_JG							= iEncodeBranch(196);
cs32	_ICODE_LSA_JNLE							= iEncodeBranch(197);
cs32	_ICODE_LSA_JMP							= iEncodeBranch(198);
cs32	_ICODE_LSA_LAHF							= iEncodeBranch(199);
cs32	_ICODE_LSA_LAR							= iEncodeBranch(200);
cs32	_ICODE_LSA_LDS							= iEncodeBranch(201);
cs32	_ICODE_LSA_LSS							= iEncodeBranch(202);
cs32	_ICODE_LSA_LES							= iEncodeBranch(203);
cs32	_ICODE_LSA_LFS							= iEncodeBranch(204);
cs32	_ICODE_LSA_LGS							= iEncodeBranch(205);
cs32	_ICODE_LSA_LEA							= iEncodeBranch(206);
cs32	_ICODE_LSA_LEAVE						= iEncodeBranch(207);
cs32	_ICODE_LSA_LGDT							= iEncodeBranch(208);
cs32	_ICODE_LSA_LIDT							= iEncodeBranch(209);
cs32	_ICODE_LSA_LLDT							= iEncodeBranch(210);
cs32	_ICODE_LSA_LMSW							= iEncodeBranch(211);
cs32	_ICODE_LSA_LOCK							= iEncodeBranch(212);
cs32	_ICODE_LSA_LODS							= iEncodeBranch(213);
cs32	_ICODE_LSA_LODSB						= iEncodeBranch(214);
cs32	_ICODE_LSA_LODSW						= iEncodeBranch(215);
cs32	_ICODE_LSA_LODSD						= iEncodeBranch(216);
cs32	_ICODE_LSA_LOOP							= iEncodeBranch(217);
cs32	_ICODE_LSA_LOOPE						= iEncodeBranch(218);
cs32	_ICODE_LSA_LOOPZ						= iEncodeBranch(219);
cs32	_ICODE_LSA_LOOPNE						= iEncodeBranch(220);
cs32	_ICODE_LSA_LOOPNZ						= iEncodeBranch(221);
cs32	_ICODE_LSA_LSL							= iEncodeBranch(222);
cs32	_ICODE_LSA_LTR							= iEncodeBranch(223);
cs32	_ICODE_LSA_MOV							= iEncodeBranch(224);
cs32	_ICODE_LSA_MOVS							= iEncodeBranch(225);
cs32	_ICODE_LSA_MOVSB						= iEncodeBranch(226);
cs32	_ICODE_LSA_MOVSW						= iEncodeBranch(227);
cs32	_ICODE_LSA_MOVSD						= iEncodeBranch(228);
cs32	_ICODE_LSA_MOVSX						= iEncodeBranch(229);
cs32	_ICODE_LSA_MOVZX						= iEncodeBranch(230);
cs32	_ICODE_LSA_MUL							= iEncodeBranch(231);
cs32	_ICODE_LSA_NEG							= iEncodeBranch(232);
cs32	_ICODE_LSA_NOP							= iEncodeBranch(233);
cs32	_ICODE_LSA_NOT							= iEncodeBranch(234);
cs32	_ICODE_LSA_OR							= iEncodeBranch(235);
cs32	_ICODE_LSA_OUT							= iEncodeBranch(236);
cs32	_ICODE_LSA_OUTS							= iEncodeBranch(237);
cs32	_ICODE_LSA_OUTSB						= iEncodeBranch(238);
cs32	_ICODE_LSA_OUTSW						= iEncodeBranch(239);
cs32	_ICODE_LSA_OUTSD						= iEncodeBranch(240);
cs32	_ICODE_LSA_POP							= iEncodeBranch(241);
cs32	_ICODE_LSA_POPA							= iEncodeBranch(242);
cs32	_ICODE_LSA_POPAD						= iEncodeBranch(243);
cs32	_ICODE_LSA_POPF							= iEncodeBranch(244);
cs32	_ICODE_LSA_POPFD						= iEncodeBranch(245);
cs32	_ICODE_LSA_PREFETCH0					= iEncodeBranch(246);
cs32	_ICODE_LSA_PREFETCH1					= iEncodeBranch(247);
cs32	_ICODE_LSA_PREFETCH2					= iEncodeBranch(248);
cs32	_ICODE_LSA_PREFETCHNTA					= iEncodeBranch(249);
cs32	_ICODE_LSA_PUSH							= iEncodeBranch(250);
cs32	_ICODE_LSA_PUSHA						= iEncodeBranch(251);
cs32	_ICODE_LSA_PUSHAD						= iEncodeBranch(252);
cs32	_ICODE_LSA_PUSHF						= iEncodeBranch(253);
cs32	_ICODE_LSA_PUSHFD						= iEncodeBranch(254);
cs32	_ICODE_LSA_RCL							= iEncodeBranch(255);
cs32	_ICODE_LSA_RCR							= iEncodeBranch(256);
cs32	_ICODE_LSA_REPNE						= iEncodeBranch(257);
cs32	_ICODE_LSA_REPNZ						= iEncodeBranch(258);
cs32	_ICODE_LSA_REPE							= iEncodeBranch(259);
cs32	_ICODE_LSA_REPZ							= iEncodeBranch(260);
cs32	_ICODE_LSA_ROL							= iEncodeBranch(261);
cs32	_ICODE_LSA_ROR							= iEncodeBranch(262);
cs32	_ICODE_LSA_RDMSR						= iEncodeBranch(263);
cs32	_ICODE_LSA_RDPMC						= iEncodeBranch(264);
cs32	_ICODE_LSA_RDTSC						= iEncodeBranch(265);
cs32	_ICODE_LSA_RET							= iEncodeBranch(266);
cs32	_ICODE_LSA_SAHF							= iEncodeBranch(267);
cs32	_ICODE_LSA_SAR							= iEncodeBranch(268);
cs32	_ICODE_LSA_SHL							= iEncodeBranch(269);
cs32	_ICODE_LSA_SHR							= iEncodeBranch(270);
cs32	_ICODE_LSA_SBB							= iEncodeBranch(271);
cs32	_ICODE_LSA_SCAS							= iEncodeBranch(272);
cs32	_ICODE_LSA_SCASB						= iEncodeBranch(273);
cs32	_ICODE_LSA_SCASW						= iEncodeBranch(274);
cs32	_ICODE_LSA_SCASD						= iEncodeBranch(275);
cs32	_ICODE_LSA_SETO							= iEncodeBranch(276);
cs32	_ICODE_LSA_SETNO						= iEncodeBranch(277);
cs32	_ICODE_LSA_SETB							= iEncodeBranch(278);
cs32	_ICODE_LSA_SETNAE						= iEncodeBranch(279);
cs32	_ICODE_LSA_SETAE						= iEncodeBranch(280);
cs32	_ICODE_LSA_SETNB						= iEncodeBranch(281);
cs32	_ICODE_LSA_SETZ							= iEncodeBranch(282);
cs32	_ICODE_LSA_SETE							= iEncodeBranch(283);
cs32	_ICODE_LSA_SETNZ						= iEncodeBranch(284);
cs32	_ICODE_LSA_SETNE						= iEncodeBranch(285);
cs32	_ICODE_LSA_SETNA						= iEncodeBranch(286);
cs32	_ICODE_LSA_SETBE						= iEncodeBranch(287);
cs32	_ICODE_LSA_SETA							= iEncodeBranch(288);
cs32	_ICODE_LSA_SETNBE						= iEncodeBranch(289);
cs32	_ICODE_LSA_SETS							= iEncodeBranch(290);
cs32	_ICODE_LSA_SETNS						= iEncodeBranch(291);
cs32	_ICODE_LSA_SETP							= iEncodeBranch(292);
cs32	_ICODE_LSA_SETPE						= iEncodeBranch(293);
cs32	_ICODE_LSA_SETNP						= iEncodeBranch(294);
cs32	_ICODE_LSA_SETPO						= iEncodeBranch(295);
cs32	_ICODE_LSA_SETL							= iEncodeBranch(296);
cs32	_ICODE_LSA_SETNGE						= iEncodeBranch(297);
cs32	_ICODE_LSA_SETGE						= iEncodeBranch(298);
cs32	_ICODE_LSA_SETNL						= iEncodeBranch(299);
cs32	_ICODE_LSA_SETLE						= iEncodeBranch(300);
cs32	_ICODE_LSA_SETNG						= iEncodeBranch(301);
cs32	_ICODE_LSA_SETG							= iEncodeBranch(302);
cs32	_ICODE_LSA_SETNLE						= iEncodeBranch(303);
cs32	_ICODE_LSA_SGDT							= iEncodeBranch(304);
cs32	_ICODE_LSA_SIDT							= iEncodeBranch(305);
cs32	_ICODE_LSA_SLDT							= iEncodeBranch(306);
cs32	_ICODE_LSA_SHLD							= iEncodeBranch(307);
cs32	_ICODE_LSA_SHRD							= iEncodeBranch(308);
cs32	_ICODE_LSA_SMSW							= iEncodeBranch(309);
cs32	_ICODE_LSA_STC							= iEncodeBranch(310);
cs32	_ICODE_LSA_STD							= iEncodeBranch(311);
cs32	_ICODE_LSA_STI							= iEncodeBranch(312);
cs32	_ICODE_LSA_STOS							= iEncodeBranch(313);
cs32	_ICODE_LSA_STOSB						= iEncodeBranch(314);
cs32	_ICODE_LSA_STOSW						= iEncodeBranch(315);
cs32	_ICODE_LSA_STOSD						= iEncodeBranch(316);
cs32	_ICODE_LSA_STR							= iEncodeBranch(317);
cs32	_ICODE_LSA_SUB							= iEncodeBranch(318);
cs32	_ICODE_LSA_SYSENTER						= iEncodeBranch(319);
cs32	_ICODE_LSA_SYSEXIT						= iEncodeBranch(320);
cs32	_ICODE_LSA_TEST							= iEncodeBranch(321);
cs32	_ICODE_LSA_UD2							= iEncodeBranch(322);
cs32	_ICODE_LSA_VERR							= iEncodeBranch(323);
cs32	_ICODE_LSA_VERW							= iEncodeBranch(324);
cs32	_ICODE_LSA_FWAIT						= iEncodeBranch(325);
cs32	_ICODE_LSA_WBINVD						= iEncodeBranch(326);
cs32	_ICODE_LSA_WRMSR						= iEncodeBranch(327);
cs32	_ICODE_LSA_XADD							= iEncodeBranch(328);
cs32	_ICODE_LSA_XCHG							= iEncodeBranch(329);
cs32	_ICODE_LSA_XLAT							= iEncodeBranch(330);
cs32	_ICODE_LSA_XLATB						= iEncodeBranch(331);
cs32	_ICODE_LSA_XOR							= iEncodeBranch(332);
...
//////
	...
	void ilsa_pass3(void)
	{
		...
		gsPass3_functions[iDecodeBranch(_ICODE_LSA_CMOVNLE)]._func		= iPass3Address(cmovcc);		// CMOVNLE				-- Move if nle flag condition is true
		...
		gsPass3_functions[iDecodeBranch(_ICODE_LSA_JNLE)]._func			= iPass3Address(jcc);			// JNLE					-- Conditional jump relative by imm32 offset if nle flag condition is true
