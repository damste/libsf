...
//////
	SAsciiCompSearcher	cgcKeywordsLasm[] =
	{
		...
		{ (cs8*)cgc_ptr_dword,					sizeof(cgc_ptr_dword) - 1,				false,		_ICODE_PTR_DWORD,					true,		_ICAT_POINTER_SIZE,		&colorDefault,		false,			null0,		null0	},
		{ (cs8*)cgc_ptr_word,					sizeof(cgc_ptr_word) - 1,				false,		_ICODE_PTR_WORD,					true,		_ICAT_POINTER_SIZE,		&colorDefault,		false,			null0,		null0	},
		{ (cs8*)cgc_ptr_byte,					sizeof(cgc_ptr_byte) - 1,				false,		_ICODE_PTR_BYTE,					true,		_ICAT_POINTER_SIZE,		&colorDefault,		false,			null0,		null0	},
		{ (cs8*)cgc_ptr_m16_16,					sizeof(cgc_ptr_m16_16) - 1,				false,		_ICODE_PTR_M16_16,					true,		_ICAT_POINTER_SIZE,		&colorDefault,		false,			null0,		null0	},
		{ (cs8*)cgc_ptr_m16_32,					sizeof(cgc_ptr_m16_32) - 1,				false,		_ICODE_PTR_M16_32,					true,		_ICAT_POINTER_SIZE,		&colorDefault,		false,			null0,		null0	},
		{ (cs8*)cgc_ptr_f32,					sizeof(cgc_ptr_f32) - 1,				false,		_ICODE_PTR_F32,						true,		_ICAT_POINTER_SIZE,		&colorDefault,		false,			null0,		null0	},
		{ (cs8*)cgc_ptr_f64,					sizeof(cgc_ptr_f64) - 1,				false,		_ICODE_PTR_F64,						true,		_ICAT_POINTER_SIZE,		&colorDefault,		false,			null0,		null0	},
		{ (cs8*)cgc_ptr_f80,					sizeof(cgc_ptr_f80) - 1,				false,		_ICODE_PTR_F80,						true,		_ICAT_POINTER_SIZE,		&colorDefault,		false,			null0,		null0	},
		{ (cs8*)cgc_ptr_s16,					sizeof(cgc_ptr_s16) - 1,				false,		_ICODE_PTR_S16,						true,		_ICAT_POINTER_SIZE,		&colorDefault,		false,			null0,		null0	},
		{ (cs8*)cgc_ptr_s32,					sizeof(cgc_ptr_s32) - 1,				false,		_ICODE_PTR_S32,						true,		_ICAT_POINTER_SIZE,		&colorDefault,		false,			null0,		null0	},
		{ (cs8*)cgc_ptr_s64,					sizeof(cgc_ptr_s64) - 1,				false,		_ICODE_PTR_S64,						true,		_ICAT_POINTER_SIZE,		&colorDefault,		false,			null0,		null0	},
		{ (cs8*)cgc_ptr_m80,					sizeof(cgc_ptr_m80) - 1,				false,		_ICODE_PTR_M80,						true,		_ICAT_POINTER_SIZE,		&colorDefault,		false,			null0,		null0	},
		{ (cs8*)cgc_ptr_mmx,					sizeof(cgc_ptr_mmx) - 1,				false,		_ICODE_PTR_MMX,						true,		_ICAT_POINTER_SIZE,		&colorDefault,		false,			null0,		null0	},
		{ (cs8*)cgc_ptr_xmmx,					sizeof(cgc_ptr_xmmx) - 1,				false,		_ICODE_PTR_XMMX,					true,		_ICAT_POINTER_SIZE,		&colorDefault,		false,			null0,		null0	},
		{ (cs8*)cgc_ptr_fpu,					sizeof(cgc_ptr_fpu) - 1,				false,		_ICODE_PTR_FPU,						true,		_ICAT_POINTER_SIZE,		&colorDefault,		false,			null0,		null0	},
		{ (cs8*)cgc_ptr_6byte,					sizeof(cgc_ptr_6byte) - 1,				false,		_ICODE_PTR_6BYTE,					true,		_ICAT_POINTER_SIZE,		&colorDefault,		false,			null0,		null0	},
		{ (cs8*)cgc_ptr_10byte,					sizeof(cgc_ptr_10byte) - 1,				false,		_ICODE_PTR_10BYTE,					true,		_ICAT_POINTER_SIZE,		&colorDefault,		false,			null0,		null0	},
		{ (cs8*)cgc_ptr_14byte,					sizeof(cgc_ptr_14byte) - 1,				false,		_ICODE_PTR_14BYTE,					true,		_ICAT_POINTER_SIZE,		&colorDefault,		false,			null0,		null0	},
		...
		{ (cs8*)cgc_dl_reg,						sizeof(cgc_dl_reg) - 1,					false,		_ICODE_DL,							true,		_ICAT_REGISTER,			&colorDefault,		false,			null0,		null0	},
		{ (cs8*)cgc_ah_reg,						sizeof(cgc_ah_reg) - 1,					false,		_ICODE_AH,							true,		_ICAT_REGISTER,			&colorDefault,		false,			null0,		null0	},
		...
		{ (cs8*)cgc_dx_reg,						sizeof(cgc_dx_reg) - 1,					false,		_ICODE_DX,							true,		_ICAT_REGISTER,			&colorDefault,		false,			null0,		null0	},
		{ (cs8*)cgc_si_reg,						sizeof(cgc_si_reg) - 1,					false,		_ICODE_SI,							true,		_ICAT_REGISTER,			&colorDefault,		false,			null0,		null0	},
		{ (cs8*)cgc_di_reg,						sizeof(cgc_di_reg) - 1,					false,		_ICODE_DI,							true,		_ICAT_REGISTER,			&colorDefault,		false,			null0,		null0	},
