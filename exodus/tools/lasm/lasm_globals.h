...
//////
	SAsciiCompSearcher	cgcKeywordsLasm[] =
	{
		...
		{ (cs8*)cgc_mm0_reg,					sizeof(cgc_mm0_reg) - 1,				false,		_ICODE_MM0,							false,		_ICAT_MM_REGISTER,		&colorDefault,		false,			null0,		null0	},
		{ (cs8*)cgc_mm1_reg,					sizeof(cgc_mm1_reg) - 1,				false,		_ICODE_MM1,							false,		_ICAT_MM_REGISTER,		&colorDefault,		false,			null0,		null0	},
		{ (cs8*)cgc_mm2_reg,					sizeof(cgc_mm2_reg) - 1,				false,		_ICODE_MM2,							false,		_ICAT_MM_REGISTER,		&colorDefault,		false,			null0,		null0	},
		{ (cs8*)cgc_mm3_reg,					sizeof(cgc_mm3_reg) - 1,				false,		_ICODE_MM3,							false,		_ICAT_MM_REGISTER,		&colorDefault,		false,			null0,		null0	},
		{ (cs8*)cgc_mm4_reg,					sizeof(cgc_mm4_reg) - 1,				false,		_ICODE_MM4,							false,		_ICAT_MM_REGISTER,		&colorDefault,		false,			null0,		null0	},
		{ (cs8*)cgc_mm5_reg,					sizeof(cgc_mm5_reg) - 1,				false,		_ICODE_MM5,							false,		_ICAT_MM_REGISTER,		&colorDefault,		false,			null0,		null0	},
		{ (cs8*)cgc_mm6_reg,					sizeof(cgc_mm6_reg) - 1,				false,		_ICODE_MM6,							false,		_ICAT_MM_REGISTER,		&colorDefault,		false,			null0,		null0	},
		{ (cs8*)cgc_mm7_reg,					sizeof(cgc_mm7_reg) - 1,				false,		_ICODE_MM7,							false,		_ICAT_MM_REGISTER,		&colorDefault,		false,			null0,		null0	},
