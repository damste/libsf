...
// Are we including the remote MDA support?
#define BX_REMOTE_MDA 1
// Are we including support for the Exodus operating system?
#define BX_FOR_EXODUS 1
...
// make it configurable through configuration interface
#ifdef BX_SUPPORT_X86_64
  #define BX_CPU_VECTOR_INTEL 0
#else
  #define BX_CPU_VECTOR_INTEL 1
#endif
