...
//////
	...
	struct SExprOp
	{
		...
		s32			eop_level;						// eop level when processing
	};
...
//////
	...
	// Expression handling
	SNode*					iComps_parseExpression						(SCallback* cb, SComp* compStart, SComp* compEnd = NULL, SBuilder* eopBase = NULL, s32 tnParseType = 1, bool* tlValid = NULL);
