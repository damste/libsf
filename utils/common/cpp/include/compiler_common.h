...
//////
	...
	cs32			_ICODE_NUMERICALPHA								= 4;
	cs32			_ICODE_OPERATOR									= 5;
	cs32			_ICODE_WHITESPACE								= 6;
	cs32			_ICODE_PLUS										= 7;
	cs32			_ICODE_MINUS								= 8;
	cs32			_ICODE_HYPHEN								= 8;
	cs32			_ICODE_ASTERISK								= 9;
	cs32			_ICODE_MULTIPLY								= 9;
	cs32			_ICODE_BACKSLASH								= 10;
	cs32			_ICODE_DOUBLE_QUOTE								= 11;
	cs32			_ICODE_SINGLE_QUOTE								= 12;
	cs32			_ICODE_TILDE									= 13;
	cs32			_ICODE_DOT										= 14;
	cs32			_ICODE_COLON									= 15;
	cs32			_ICODE_COMMA									= 16;
	cs32			_ICODE_UNDERSCORE								= 17;
	cs32			_ICODE_AT_SIGN									= 18;
	cs32			_ICODE_QUESTION_MARK							= 19;
	cs32			_ICODE_EXCLAMATION_POINT						= 20;
	cs32			_ICODE_POUND_SIGN								= 21;
	...
	cs32			_ICODE_REVERSE_QUOTE							= 27;
	cs32			_ICODE_SEMICOLON								= 28;
	cs32			_ICODE_GREATER_THAN								= 29;
