//////////
//
// /libsf/arxoda/oppie/oppie1/cpp_simulation/oppie1/debo1.cpp
//
//////
//    _     _ _     _____ _____ 
//   | |   (_) |__ / ____|  ___|
...
//////
	...
	SBitmap*		bmpLibSF_Arxoda							= NULL;			// LibSF Arxoda
...
//////
	...
	void iiDebo1_initialize(void)
	{
		...
		//////
			...
			// Externally rendered
			bmpLibSF_Arxoda = iBmp_rawLoad(cgc_libSFArxodaBmp);
...
//////
	void iiDebo1_renderRegisters(void)
	{
		...
		//////
			SetRect(&lrc, 0, 0, bmpRegisters->rc.right, bmpLibSF_Arxoda->bi.biHeight);
			iBmp_bitBlt(bmpRegisters, &lrc, bmpLibSF_Arxoda);
	}
